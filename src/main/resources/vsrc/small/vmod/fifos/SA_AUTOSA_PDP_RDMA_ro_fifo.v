...
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x64 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ro_wr -rd_pipebus ro_rd -rd_reg -rand_none -ram_bypass -d 32 -w 64 -ram ff [Chosen ram type: ff - fifogen_flops (user specified, thus no other ram type is allowed)]
...
module SA_AUTOSA_PDP_RDMA_ro_fifo_32x64 (
      autosa_core_clk
    , autosa_core_rstn
    , ro_wr_prdy
    , ro_wr_pvld
...
SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 ram (
...
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_wr_limit : 6'd0;
`else
...
`endif
    ...
    if ( $test$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// set_boundary_optimization find(design, "SA_AUTOSA_PDP_RDMA_ro_fifo_32x64") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x64
//
// Flop-Based RAM
//
module SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 (
      clk
    , pwrbus_ram_pd
    , di
    , we
...
vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra[4:0] )
...
`endif // EMU
endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
// emulation model of flopram guts
//
`ifdef EMU
module vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64) }
// set_attribute { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64] != {} } { set_attr preserve 1 [find / -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64] }
endmodule // vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
//vmw: Memory vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
//vmw: Address-size 5
//vmw: Data-size 64
...
//vmw:
//qt: CELL vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
...
//qt:
`endif // EMU
//| &Shell ${FIFOGEN} -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x32
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ro_wr
//| -rd_pipebus ro_rd
...
//
// /home/nvtools/engr/2017/03/11_05_00_06/nvtools/scripts/fifogen
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x32 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ro_wr -rd_pipebus ro_rd -rd_reg -rand_none -ram_bypass -d 32 -w 32 -ram ff [Chosen ram type: ff - fifogen_flops (user specified, thus no other ram type is allowed)]
// chip config vars: assertion_module_prefix=sa_ strict_synchronizers=1 strict_synchronizers_use_lib_cells=1 strict_synchronizers_use_tm_lib_cells=1 strict_sync_randomizer=1 assertion_message_prefix=FIFOGEN_ASSERTION allow_async_fifola=0 ignore_ramgen_fifola_variant=1 uses_p_SSYNC=0 uses_prand=1 uses_rammake_inc=1 use_x_or_0=1 force_wr_reg_gated=1 no_force_reset=1 no_timescale=1 no_pli_ifdef=1 requires_full_throughput=1 ram_auto_ff_bits_cutoff=16 ram_auto_ff_width_cutoff=2 ram_auto_ff_width_cutoff_max_depth=32 ram_auto_ff_depth_cutoff=-1 ram_auto_ff_no_la2_depth_cutoff=5 ram_auto_la2_width_cutoff=8 ram_auto_la2_width_cutoff_max_depth=56 ram_auto_la2_depth_cutoff=16 flopram_emu_model=1 dslp_single_clamp_port=1 dslp_clamp_port=1 slp_single_clamp_port=1 slp_clamp_port=1 master_clk_gated=1 clk_gate_module=SA_CLK_gate_power redundant_timing_flops=0 hot_reset_async_force_ports_and_loopback=1 ram_sleep_en_width=1 async_cdc_reg_id=SA_AFIFO_ rd_reg_default_for_async=1 async_ram_instance_prefix=SA_ASYNC_RAM_ allow_rd_busy_reg_warning=0 do_dft_xelim_gating=1 add_dft_xelim_wr_clkgate=1 add_dft_xelim_rd_clkgate=1
//
// leda B_3208_NV OFF -- Unequal length LHS and RHS in assignment
// leda B_1405 OFF -- 2 asynchronous resets in this unit detected
 `define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
 `include "sa_simulate_x_tick.vh"
 module SA_AUTOSA_PDP_RDMA_ro_fifo_32x32 (
       autosa_core_clk
     , autosa_core_rstn
     , ro_wr_prdy
     , ro_wr_pvld
...
// Adding parameter for fifogen to disable wr/rd contention assertion in ramgen.
// Fifogen handles this by ignoring the data on the ram data out for that cycle.
 SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 ram (
       .clk( autosa_core_clk_mgated )
     , .pwrbus_ram_pd ( pwrbus_ram_pd )
     , .di ( ro_wr_pd )
     , .we ( ram_we )
...
// Emulation Global Config Override
//
 assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_wr_limit : 6'd0;
 `else
// No Global Override for Emulation
//
 assign wr_limit_muxed = 6'd0;
...
// VCS coverage off
 ...
 `endif
     wr_limit_override = 0;
     wr_limit_override_value = 0; // to keep viva happy with dangles
     if ( $test$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_wr_limit" ) ) begin
         wr_limit_override = 1;
         $value$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_wr_limit=%d", wr_limit_override_value);
     end
 end
// VCS coverage on
 `endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "SA_AUTOSA_PDP_RDMA_ro_fifo_32x32") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
 endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x32
//
// Flop-Based RAM
//
 module SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 (
       clk
     , pwrbus_ram_pd
     , di
     , we
...
//
 ...
 vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 emu_ram (
      .Wa0( Wa0_vmw )
    , .we0( we0_vmw )
    , .Di0( Di0_vmw )
    , .Ra0( ra[4:0] )
...
//VCS coverage on
 ...
 `endif // EMU
 endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
// emulation model of flopram guts
//
 `ifdef EMU
 module vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 (
    Wa0, we0, Di0,
    Ra0, Do0
    );
 input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32) }
// set_attribute { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32] != {} } { set_attr preserve 1 [find / -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32] }
 endmodule // vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
//vmw: Memory vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
//vmw: Address-size 5
//vmw: Data-size 32
//vmw: Sensitivity level 1
//vmw: Ports W R
...
//vmw:
//qt: CELL vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
//qt: TERMINAL we0 TYPE=WE POLARITY=H PORT=1
//qt: TERMINAL Wa0[%d] TYPE=ADDRESS DIR=W BIT=%1 PORT=1
//qt: TERMINAL Di0[%d] TYPE=DATA DIR=I BIT=%1 PORT=1
//qt:
...
//qt:
 `endif // EMU
//| &Shell ${FIFOGEN} -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x16
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ro_wr
//| -rd_pipebus ro_rd
...
//
// /home/nvtools/engr/2017/03/11_05_00_06/nvtools/scripts/fifogen
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x16 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ro_wr -rd_pipebus ro_rd -rd_reg -rand_none -ram_bypass -d 32 -w 16 -ram ff [Chosen ram type: ff - fifogen_flops (user specified, thus no other ram type is allowed)]
// chip config vars: assertion_module_prefix=sa_ strict_synchronizers=1 strict_synchronizers_use_lib_cells=1 strict_synchronizers_use_tm_lib_cells=1 strict_sync_randomizer=1 assertion_message_prefix=FIFOGEN_ASSERTION allow_async_fifola=0 ignore_ramgen_fifola_variant=1 uses_p_SSYNC=0 uses_prand=1 uses_rammake_inc=1 use_x_or_0=1 force_wr_reg_gated=1 no_force_reset=1 no_timescale=1 no_pli_ifdef=1 requires_full_throughput=1 ram_auto_ff_bits_cutoff=16 ram_auto_ff_width_cutoff=2 ram_auto_ff_width_cutoff_max_depth=32 ram_auto_ff_depth_cutoff=-1 ram_auto_ff_no_la2_depth_cutoff=5 ram_auto_la2_width_cutoff=8 ram_auto_la2_width_cutoff_max_depth=56 ram_auto_la2_depth_cutoff=16 flopram_emu_model=1 dslp_single_clamp_port=1 dslp_clamp_port=1 slp_single_clamp_port=1 slp_clamp_port=1 master_clk_gated=1 clk_gate_module=SA_CLK_gate_power redundant_timing_flops=0 hot_reset_async_force_ports_and_loopback=1 ram_sleep_en_width=1 async_cdc_reg_id=SA_AFIFO_ rd_reg_default_for_async=1 async_ram_instance_prefix=SA_ASYNC_RAM_ allow_rd_busy_reg_warning=0 do_dft_xelim_gating=1 add_dft_xelim_wr_clkgate=1 add_dft_xelim_rd_clkgate=1
//
// leda B_3208_NV OFF -- Unequal length LHS and RHS in assignment
// leda B_1405 OFF -- 2 asynchronous resets in this unit detected
`define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
`include "sa_simulate_x_tick.vh"
module SA_AUTOSA_PDP_RDMA_ro_fifo_32x16 (
      autosa_core_clk
    , autosa_core_rstn
    , ro_wr_prdy
    , ro_wr_pvld
...
// Adding parameter for fifogen to disable wr/rd contention assertion in ramgen.
// Fifogen handles this by ignoring the data on the ram data out for that cycle.
SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 ram (
      .clk( autosa_core_clk_mgated )
    , .pwrbus_ram_pd ( pwrbus_ram_pd )
    , .di ( ro_wr_pd )
    , .we ( ram_we )
...
// Emulation Global Config Override
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_wr_limit : 6'd0;
`else
// No Global Override for Emulation
//
assign wr_limit_muxed = 6'd0;
...
`endif
    wr_limit_override = 0;
    wr_limit_override_value = 0; // to keep viva happy with dangles
    if ( $test$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "SA_AUTOSA_PDP_RDMA_ro_fifo_32x16") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x16
//
// Flop-Based RAM
//
module SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 (
      clk
    , pwrbus_ram_pd
    , di
    , we
...
vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra[4:0] )
...
`endif // EMU
endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
// emulation model of flopram guts
//
`ifdef EMU
module vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16) }
// set_attribute { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16] != {} } { set_attr preserve 1 [find / -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16] }
endmodule // vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
//vmw: Memory vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
//vmw: Address-size 5
//vmw: Data-size 16
//vmw: Sensitivity level 1
//vmw: Ports W R
...
//vmw:
//qt: CELL vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
//qt: TERMINAL we0 TYPE=WE POLARITY=H PORT=1
//qt: TERMINAL Wa0[%d] TYPE=ADDRESS DIR=W BIT=%1 PORT=1
//qt: TERMINAL Di0[%d] TYPE=DATA DIR=I BIT=%1 PORT=1
//qt:
...
//qt:
`endif // EMU
//| &Shell ${FIFOGEN} -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x8
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ro_wr
//| -rd_pipebus ro_rd
...
//
// /home/nvtools/engr/2017/03/11_05_00_06/nvtools/scripts/fifogen
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_PDP_RDMA_ro_fifo_32x8 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ro_wr -rd_pipebus ro_rd -rd_reg -rand_none -ram_bypass -d 32 -w 8 -ram ff [Chosen ram type: ff - fifogen_flops (user specified, thus no other ram type is allowed)]
// chip config vars: assertion_module_prefix=sa_ strict_synchronizers=1 strict_synchronizers_use_lib_cells=1 strict_synchronizers_use_tm_lib_cells=1 strict_sync_randomizer=1 assertion_message_prefix=FIFOGEN_ASSERTION allow_async_fifola=0 ignore_ramgen_fifola_variant=1 uses_p_SSYNC=0 uses_prand=1 uses_rammake_inc=1 use_x_or_0=1 force_wr_reg_gated=1 no_force_reset=1 no_timescale=1 no_pli_ifdef=1 requires_full_throughput=1 ram_auto_ff_bits_cutoff=16 ram_auto_ff_width_cutoff=2 ram_auto_ff_width_cutoff_max_depth=32 ram_auto_ff_depth_cutoff=-1 ram_auto_ff_no_la2_depth_cutoff=5 ram_auto_la2_width_cutoff=8 ram_auto_la2_width_cutoff_max_depth=56 ram_auto_la2_depth_cutoff=16 flopram_emu_model=1 dslp_single_clamp_port=1 dslp_clamp_port=1 slp_single_clamp_port=1 slp_clamp_port=1 master_clk_gated=1 clk_gate_module=SA_CLK_gate_power redundant_timing_flops=0 hot_reset_async_force_ports_and_loopback=1 ram_sleep_en_width=1 async_cdc_reg_id=SA_AFIFO_ rd_reg_default_for_async=1 async_ram_instance_prefix=SA_ASYNC_RAM_ allow_rd_busy_reg_warning=0 do_dft_xelim_gating=1 add_dft_xelim_wr_clkgate=1 add_dft_xelim_rd_clkgate=1
//
// leda B_3208_NV OFF -- Unequal length LHS and RHS in assignment
// leda B_1405 OFF -- 2 asynchronous resets in this unit detected
`define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
`include "sa_simulate_x_tick.vh"
module SA_AUTOSA_PDP_RDMA_ro_fifo_32x8 (
      autosa_core_clk
    , autosa_core_rstn
    , ro_wr_prdy
    , ro_wr_pvld
...
// Adding parameter for fifogen to disable wr/rd contention assertion in ramgen.
// Fifogen handles this by ignoring the data on the ram data out for that cycle.
SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 ram (
      .clk( autosa_core_clk_mgated )
    , .pwrbus_ram_pd ( pwrbus_ram_pd )
    , .di ( ro_wr_pd )
    , .we ( ram_we )
...
// Emulation Global Config Override
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_wr_limit : 6'd0;
`else
// No Global Override for Emulation
//
assign wr_limit_muxed = 6'd0;
...
`endif
    wr_limit_override = 0;
    wr_limit_override_value = 0; // to keep viva happy with dangles
    if ( $test$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "SA_AUTOSA_PDP_RDMA_ro_fifo_32x8") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x8
//
// Flop-Based RAM
//
module SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 (
      clk
    , pwrbus_ram_pd
    , di
    , we
...
vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra[4:0] )
...
`endif // EMU
endmodule // SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
// emulation model of flopram guts
//
`ifdef EMU
module vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8) }
// set_attribute { find (design, vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8] != {} } { set_attr preserve 1 [find / -subdesign vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8] }
endmodule // vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
//vmw: Memory vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
//vmw: Address-size 5
//vmw: Data-size 8
//vmw: Sensitivity level 1
//vmw: Ports W R
...
//vmw:
//qt: CELL vmw_SA_AUTOSA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
//qt: TERMINAL we0 TYPE=WE POLARITY=H PORT=1
//qt: TERMINAL Wa0[%d] TYPE=ADDRESS DIR=W BIT=%1 PORT=1
//qt: TERMINAL Di0[%d] TYPE=DATA DIR=I BIT=%1 PORT=1
//qt:
