...
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_SDP_NRDMA_cq_256x16 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ig2cq -rd_pipebus cq2eg -rd_reg -d 256 -w 16 -rand_none -ram ra2 [Chosen ram type: ra2 - ramgen_generic (user specified, thus no other ram type is allowed)]
...
module SA_AUTOSA_SDP_NRDMA_cq_256x16 (
      autosa_core_clk
    , autosa_core_rstn
    , ig2cq_prdy
    , ig2cq_pvld
...
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_SDP_NRDMA_cq_256x16_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_SDP_NRDMA_cq_256x16_wr_limit : 9'd0;
`else
...
`endif
    ...
    if ( $test$plusargs( "SA_AUTOSA_SDP_NRDMA_cq_256x16_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_SDP_NRDMA_cq_256x16_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// set_boundary_optimization find(design, "SA_AUTOSA_SDP_NRDMA_cq_256x16") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_SDP_NRDMA_cq_256x16
//| &Shell ${FIFOGEN} -stdout -m SA_AUTOSA_SDP_NRDMA_cq_::eval(64 )x::eval(16 )
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ig2cq
//| -rd_pipebus cq2eg
...
//
// /home/nvtools/engr/2017/03/11_05_00_06/nvtools/scripts/fifogen
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_SDP_NRDMA_cq_64x16 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ig2cq -rd_pipebus cq2eg -rd_reg -d 64 -w 16 -rand_none -ram ra2 [Chosen ram type: ra2 - ramgen_generic (user specified, thus no other ram type is allowed)]
// chip config vars: assertion_module_prefix=sa_ strict_synchronizers=1 strict_synchronizers_use_lib_cells=1 strict_synchronizers_use_tm_lib_cells=1 strict_sync_randomizer=1 assertion_message_prefix=FIFOGEN_ASSERTION allow_async_fifola=0 ignore_ramgen_fifola_variant=1 uses_p_SSYNC=0 uses_prand=1 uses_rammake_inc=1 use_x_or_0=1 force_wr_reg_gated=1 no_force_reset=1 no_timescale=1 no_pli_ifdef=1 requires_full_throughput=1 ram_auto_ff_bits_cutoff=16 ram_auto_ff_width_cutoff=2 ram_auto_ff_width_cutoff_max_depth=32 ram_auto_ff_depth_cutoff=-1 ram_auto_ff_no_la2_depth_cutoff=5 ram_auto_la2_width_cutoff=8 ram_auto_la2_width_cutoff_max_depth=56 ram_auto_la2_depth_cutoff=16 flopram_emu_model=1 dslp_single_clamp_port=1 dslp_clamp_port=1 slp_single_clamp_port=1 slp_clamp_port=1 master_clk_gated=1 clk_gate_module=SA_CLK_gate_power redundant_timing_flops=0 hot_reset_async_force_ports_and_loopback=1 ram_sleep_en_width=1 async_cdc_reg_id=SA_AFIFO_ rd_reg_default_for_async=1 async_ram_instance_prefix=SA_ASYNC_RAM_ allow_rd_busy_reg_warning=0 do_dft_xelim_gating=1 add_dft_xelim_wr_clkgate=1 add_dft_xelim_rd_clkgate=1
//
// leda B_3208_NV OFF -- Unequal length LHS and RHS in assignment
// leda B_1405 OFF -- 2 asynchronous resets in this unit detected
`define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
`include "sa_simulate_x_tick.vh"
module SA_AUTOSA_SDP_NRDMA_cq_64x16 (
      autosa_core_clk
    , autosa_core_rstn
    , ig2cq_prdy
    , ig2cq_pvld
...
// Emulation Global Config Override
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_SDP_NRDMA_cq_64x16_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_SDP_NRDMA_cq_64x16_wr_limit : 7'd0;
`else
// No Global Override for Emulation
//
...
`endif
    wr_limit_override = 0;
    wr_limit_override_value = 0; // to keep viva happy with dangles
    if ( $test$plusargs( "SA_AUTOSA_SDP_NRDMA_cq_64x16_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_SDP_NRDMA_cq_64x16_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "SA_AUTOSA_SDP_NRDMA_cq_64x16") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_SDP_NRDMA_cq_64x16
//| &Shell ${FIFOGEN} -stdout -m SA_AUTOSA_SDP_NRDMA_cq_::eval(16 )x::eval(16 )
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ig2cq
//| -rd_pipebus cq2eg
...
//
// /home/nvtools/engr/2017/03/11_05_00_06/nvtools/scripts/fifogen
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_SDP_NRDMA_cq_16x16 -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ig2cq -rd_pipebus cq2eg -rd_reg -d 16 -w 16 -rand_none -ram ra2 [Chosen ram type: ra2 - ramgen_generic (user specified, thus no other ram type is allowed)]
// chip config vars: assertion_module_prefix=sa_ strict_synchronizers=1 strict_synchronizers_use_lib_cells=1 strict_synchronizers_use_tm_lib_cells=1 strict_sync_randomizer=1 assertion_message_prefix=FIFOGEN_ASSERTION allow_async_fifola=0 ignore_ramgen_fifola_variant=1 uses_p_SSYNC=0 uses_prand=1 uses_rammake_inc=1 use_x_or_0=1 force_wr_reg_gated=1 no_force_reset=1 no_timescale=1 no_pli_ifdef=1 requires_full_throughput=1 ram_auto_ff_bits_cutoff=16 ram_auto_ff_width_cutoff=2 ram_auto_ff_width_cutoff_max_depth=32 ram_auto_ff_depth_cutoff=-1 ram_auto_ff_no_la2_depth_cutoff=5 ram_auto_la2_width_cutoff=8 ram_auto_la2_width_cutoff_max_depth=56 ram_auto_la2_depth_cutoff=16 flopram_emu_model=1 dslp_single_clamp_port=1 dslp_clamp_port=1 slp_single_clamp_port=1 slp_clamp_port=1 master_clk_gated=1 clk_gate_module=SA_CLK_gate_power redundant_timing_flops=0 hot_reset_async_force_ports_and_loopback=1 ram_sleep_en_width=1 async_cdc_reg_id=SA_AFIFO_ rd_reg_default_for_async=1 async_ram_instance_prefix=SA_ASYNC_RAM_ allow_rd_busy_reg_warning=0 do_dft_xelim_gating=1 add_dft_xelim_wr_clkgate=1 add_dft_xelim_rd_clkgate=1
//
// leda B_3208_NV OFF -- Unequal length LHS and RHS in assignment
// leda B_1405 OFF -- 2 asynchronous resets in this unit detected
`define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
`include "sa_simulate_x_tick.vh"
module SA_AUTOSA_SDP_NRDMA_cq_16x16 (
      autosa_core_clk
    , autosa_core_rstn
    , ig2cq_prdy
    , ig2cq_pvld
...
// Emulation Global Config Override
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_SDP_NRDMA_cq_16x16_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_SDP_NRDMA_cq_16x16_wr_limit : 5'd0;
`else
// No Global Override for Emulation
//
...
`endif
    wr_limit_override = 0;
    wr_limit_override_value = 0; // to keep viva happy with dangles
    if ( $test$plusargs( "SA_AUTOSA_SDP_NRDMA_cq_16x16_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_SDP_NRDMA_cq_16x16_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "SA_AUTOSA_SDP_NRDMA_cq_16x16") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_SDP_NRDMA_cq_16x16
