// sa_ram_rwsp_160x514: synthesizable model wrapper
...
// This wrapper consists of : 4 Ram cells: AUTOSARAMPDP_160X144_GL_M2_D2 AUTOSARAMPDP_160X144_GL_M2_D2 AUTOSARAMPDP_160X144_GL_M2_D2 AUTOSARAMPDP_160X82_GL_M2_D2 ;
...
sa_ram_rwsp_160x514_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_160x514 (
...
integer row;
begin
// initializing AUTOSARAMPDP_160X144_GL_M2_D2
for (row = 0; row < 160; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_160x514.ram_Inst_160X144_0_0.mem_write(row - 0, shadow_mem[row][143:0]);
// initializing AUTOSARAMPDP_160X144_GL_M2_D2
for (row = 0; row < 160; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_160x514.ram_Inst_160X144_0_144.mem_write(row - 0, shadow_mem[row][287:144]);
// initializing AUTOSARAMPDP_160X144_GL_M2_D2
for (row = 0; row < 160; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_160x514.ram_Inst_160X144_0_288.mem_write(row - 0, shadow_mem[row][431:288]);
// initializing AUTOSARAMPDP_160X82_GL_M2_D2
for (row = 0; row < 160; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_160x514.ram_Inst_160X82_0_432.mem_write(row - 0, shadow_mem[row][513:432]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [513:0] data;
begin
// probing AUTOSARAMPDP_160X144_GL_M2_D2
 if (row >= 0 && row < 160) data[143:0] = r_sa_ram_rwsp_160x514.ram_Inst_160X144_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_160X144_GL_M2_D2
 if (row >= 0 && row < 160) data[287:144] = r_sa_ram_rwsp_160x514.ram_Inst_160X144_0_144.mem_read(row - 0);
// probing AUTOSARAMPDP_160X144_GL_M2_D2
 if (row >= 0 && row < 160) data[431:288] = r_sa_ram_rwsp_160x514.ram_Inst_160X144_0_288.mem_read(row - 0);
// probing AUTOSARAMPDP_160X82_GL_M2_D2
 if (row >= 0 && row < 160) data[513:432] = r_sa_ram_rwsp_160x514.ram_Inst_160X82_0_432.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
