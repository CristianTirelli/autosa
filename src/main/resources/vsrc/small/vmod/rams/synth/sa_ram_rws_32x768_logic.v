...
// ================================================================
// File Name: sa_ram_rws_32x768_logic.v
...
module sa_ram_rws_32x768_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix _0_0 : Piece AUTOSARAMPDP_32X288_GL_M1_D2 (RamCell)
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_32X288_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 31 Addressrange: [4:0]
...
assign re_0_288 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_576 : Piece AUTOSARAMPDP_32X192_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 31 Addressrange: [4:0]
...
// ----------------- begin Ram Cell AUTOSARAMPDP_32X288_GL_M1_D2_0_0 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_32X288_GL_M1_D2 ram_Inst_32X288_0_0 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_32X288_GL_M1_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_32X288_GL_M1_D2 ram_Inst_32X288_0_288 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_32X192_GL_M1_D2_0_576 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_32X192_GL_M1_D2 ram_Inst_32X192_0_576 (
...
//For bitEnd 287, only one piece AUTOSARAMPDP_32X288_GL_M1_D2 in the column.
...
//For bitEnd 575, only one piece AUTOSARAMPDP_32X288_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 767, only one piece AUTOSARAMPDP_32X192_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(5, 0, 0) testInst_Wa_reg_w0 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(5, 0, 0) testInst_Ra_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
