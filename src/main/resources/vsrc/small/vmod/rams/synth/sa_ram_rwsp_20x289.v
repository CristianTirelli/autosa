...
// ================================================================
// File Name: sa_ram_rwsp_20x289.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 1 Ram cells: AUTOSARAMDP_20X288_GL_M1_E2 Flop_Array ; 1 Flop Arrays;
...
sa_ram_rwsp_20x289_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_20x289 (
...
integer row;
begin
// initializing AUTOSARAMDP_20X288_GL_M1_E2
for (row = 0; row < 20; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_20x289.ram_Inst_20X288_0_0.mem_write(row - 0, shadow_mem[row][287:0]);
// initializing Flop_Array
if (shadow_written[0]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row0_0_288 = shadow_mem[0][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row0_0_288_d = shadow_mem[0][288:288];
end
if (shadow_written[1]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row1_0_288 = shadow_mem[1][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row1_0_288_d = shadow_mem[1][288:288];
end
if (shadow_written[2]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row2_0_288 = shadow_mem[2][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row2_0_288_d = shadow_mem[2][288:288];
end
if (shadow_written[3]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row3_0_288 = shadow_mem[3][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row3_0_288_d = shadow_mem[3][288:288];
end
if (shadow_written[4]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row4_0_288 = shadow_mem[4][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row4_0_288_d = shadow_mem[4][288:288];
end
if (shadow_written[5]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row5_0_288 = shadow_mem[5][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row5_0_288_d = shadow_mem[5][288:288];
end
if (shadow_written[6]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row6_0_288 = shadow_mem[6][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row6_0_288_d = shadow_mem[6][288:288];
end
if (shadow_written[7]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row7_0_288 = shadow_mem[7][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row7_0_288_d = shadow_mem[7][288:288];
end
if (shadow_written[8]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row8_0_288 = shadow_mem[8][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row8_0_288_d = shadow_mem[8][288:288];
end
if (shadow_written[9]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row9_0_288 = shadow_mem[9][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row9_0_288_d = shadow_mem[9][288:288];
end
if (shadow_written[10]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row10_0_288 = shadow_mem[10][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row10_0_288_d = shadow_mem[10][288:288];
end
if (shadow_written[11]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row11_0_288 = shadow_mem[11][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row11_0_288_d = shadow_mem[11][288:288];
end
if (shadow_written[12]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row12_0_288 = shadow_mem[12][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row12_0_288_d = shadow_mem[12][288:288];
end
if (shadow_written[13]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row13_0_288 = shadow_mem[13][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row13_0_288_d = shadow_mem[13][288:288];
end
if (shadow_written[14]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row14_0_288 = shadow_mem[14][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row14_0_288_d = shadow_mem[14][288:288];
end
if (shadow_written[15]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row15_0_288 = shadow_mem[15][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row15_0_288_d = shadow_mem[15][288:288];
end
if (shadow_written[16]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row16_0_288 = shadow_mem[16][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row16_0_288_d = shadow_mem[16][288:288];
end
if (shadow_written[17]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row17_0_288 = shadow_mem[17][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row17_0_288_d = shadow_mem[17][288:288];
end
if (shadow_written[18]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row18_0_288 = shadow_mem[18][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row18_0_288_d = shadow_mem[18][288:288];
end
if (shadow_written[19]) begin
    r_sa_ram_rwsp_20x289.FlopArray_row19_0_288 = shadow_mem[19][288:288];
    force r_sa_ram_rwsp_20x289.FlopArray_row19_0_288_d = shadow_mem[19][288:288];
end
#1 ;
if (shadow_written[0]) release r_sa_ram_rwsp_20x289.FlopArray_row0_0_288_d;
if (shadow_written[1]) release r_sa_ram_rwsp_20x289.FlopArray_row1_0_288_d;
if (shadow_written[2]) release r_sa_ram_rwsp_20x289.FlopArray_row2_0_288_d;
if (shadow_written[3]) release r_sa_ram_rwsp_20x289.FlopArray_row3_0_288_d;
if (shadow_written[4]) release r_sa_ram_rwsp_20x289.FlopArray_row4_0_288_d;
if (shadow_written[5]) release r_sa_ram_rwsp_20x289.FlopArray_row5_0_288_d;
if (shadow_written[6]) release r_sa_ram_rwsp_20x289.FlopArray_row6_0_288_d;
if (shadow_written[7]) release r_sa_ram_rwsp_20x289.FlopArray_row7_0_288_d;
if (shadow_written[8]) release r_sa_ram_rwsp_20x289.FlopArray_row8_0_288_d;
if (shadow_written[9]) release r_sa_ram_rwsp_20x289.FlopArray_row9_0_288_d;
if (shadow_written[10]) release r_sa_ram_rwsp_20x289.FlopArray_row10_0_288_d;
if (shadow_written[11]) release r_sa_ram_rwsp_20x289.FlopArray_row11_0_288_d;
if (shadow_written[12]) release r_sa_ram_rwsp_20x289.FlopArray_row12_0_288_d;
if (shadow_written[13]) release r_sa_ram_rwsp_20x289.FlopArray_row13_0_288_d;
if (shadow_written[14]) release r_sa_ram_rwsp_20x289.FlopArray_row14_0_288_d;
if (shadow_written[15]) release r_sa_ram_rwsp_20x289.FlopArray_row15_0_288_d;
if (shadow_written[16]) release r_sa_ram_rwsp_20x289.FlopArray_row16_0_288_d;
if (shadow_written[17]) release r_sa_ram_rwsp_20x289.FlopArray_row17_0_288_d;
if (shadow_written[18]) release r_sa_ram_rwsp_20x289.FlopArray_row18_0_288_d;
if (shadow_written[19]) release r_sa_ram_rwsp_20x289.FlopArray_row19_0_288_d;
shadow_written = 'b0;
end
endtask
`endif
...
reg [288:0] data;
begin
// probing AUTOSARAMDP_20X288_GL_M1_E2
 if (row >= 0 && row < 20) data[287:0] = r_sa_ram_rwsp_20x289.ram_Inst_20X288_0_0.mem_read(row - 0);
// probing Flop_Array
if (row == 0) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row0_0_288;
if (row == 1) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row1_0_288;
if (row == 2) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row2_0_288;
if (row == 3) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row3_0_288;
if (row == 4) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row4_0_288;
if (row == 5) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row5_0_288;
if (row == 6) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row6_0_288;
if (row == 7) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row7_0_288;
if (row == 8) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row8_0_288;
if (row == 9) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row9_0_288;
if (row == 10) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row10_0_288;
if (row == 11) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row11_0_288;
if (row == 12) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row12_0_288;
if (row == 13) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row13_0_288;
if (row == 14) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row14_0_288;
if (row == 15) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row15_0_288;
if (row == 16) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row16_0_288;
if (row == 17) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row17_0_288;
if (row == 18) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row18_0_288;
if (row == 19) data[288:288] = r_sa_ram_rwsp_20x289.FlopArray_row19_0_288;
    probe_mem_val = data;
end
endfunction
`endif
