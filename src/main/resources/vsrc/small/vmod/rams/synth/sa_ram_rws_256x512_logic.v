...
// ================================================================
// File Name: sa_ram_rws_256x512_logic.v
...
module sa_ram_rws_256x512_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix _0_0 : Piece AUTOSARAMPDP_256X144_GL_M2_D2 (RamCell)
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_144 : Piece AUTOSARAMPDP_256X144_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 255 Addressrange: [7:0]
...
assign re_0_144 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_256X144_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 255 Addressrange: [7:0]
...
assign re_0_288 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_432 : Piece AUTOSARAMPDP_256X80_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 255 Addressrange: [7:0]
...
// ----------------- begin Ram Cell AUTOSARAMPDP_256X144_GL_M2_D2_0_0 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_256X144_GL_M2_D2 ram_Inst_256X144_0_0 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_256X144_GL_M2_D2_0_144 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_256X144_GL_M2_D2 ram_Inst_256X144_0_144 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_256X144_GL_M2_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_256X144_GL_M2_D2 ram_Inst_256X144_0_288 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_256X80_GL_M2_D2_0_432 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_256X80_GL_M2_D2 ram_Inst_256X80_0_432 (
...
//For bitEnd 143, only one piece AUTOSARAMPDP_256X144_GL_M2_D2 in the column.
...
//For bitEnd 287, only one piece AUTOSARAMPDP_256X144_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 431, only one piece AUTOSARAMPDP_256X144_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 511, only one piece AUTOSARAMPDP_256X80_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
