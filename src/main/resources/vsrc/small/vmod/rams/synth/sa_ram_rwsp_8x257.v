// sa_ram_rwsp_8x257: synthesizable model wrapper
...
// This wrapper consists of : 1 Ram cells: AUTOSARAMDP_8X258_GL_M1_E2 ;
...
sa_ram_rwsp_8x257_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_8x257 (
...
integer row;
begin
// initializing AUTOSARAMDP_8X258_GL_M1_E2
for (row = 0; row < 8; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_8x257.ram_Inst_8X258.mem_write(row - 0, shadow_mem[row][256:0]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [256:0] data;
begin
// probing AUTOSARAMDP_8X258_GL_M1_E2
 if (row >= 0 && row < 8) data[256:0] = r_sa_ram_rwsp_8x257.ram_Inst_8X258.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
