...
// ================================================================
// File Name: sa_ram_rws_16x272_logic.v
...
module sa_ram_rws_16x272_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMDP_16X272_GL_M1_E2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMDP_16X272_GL_M1_E2 -------------
// Write Port Stuff -----
...
AUTOSARAMDP_16X272_GL_M1_E2 ram_Inst_16X272 (
...
//For bitEnd 271, only one piece AUTOSARAMDP_16X272_GL_M1_E2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(4, 0, 0) testInst_Wa_reg_w0 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(4, 0, 0) testInst_Ra_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
