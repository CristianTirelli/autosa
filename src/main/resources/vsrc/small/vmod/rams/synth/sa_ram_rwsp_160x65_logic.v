...
// ================================================================
// File Name: sa_ram_rwsp_160x65_logic.v
...
module sa_ram_rwsp_160x65_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_160X65_GL_M2_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_160X65_GL_M2_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_160X65_GL_M2_D2 ram_Inst_160X65 (
                                          .CLK (gated_clk_core)
                                        , .WADR_7 (wa_0_0[7])
                                        , .WADR_6 (wa_0_0[6])
                                        , .WADR_5 (wa_0_0[5])
...
//For bitEnd 64, only one piece AUTOSARAMPDP_160X65_GL_M2_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(65, 0, 0) testInst_Data_reg_r0 (
