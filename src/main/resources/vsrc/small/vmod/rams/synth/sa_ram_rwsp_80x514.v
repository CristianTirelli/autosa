// sa_ram_rwsp_80x514: synthesizable model wrapper
...
// This wrapper consists of : 2 Ram cells: AUTOSARAMPDP_80X288_GL_M1_D2 AUTOSARAMPDP_80X226_GL_M1_D2 ;
...
sa_ram_rwsp_80x514_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_80x514 (
...
integer row;
begin
// initializing AUTOSARAMPDP_80X288_GL_M1_D2
for (row = 0; row < 80; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_80x514.ram_Inst_80X288_0_0.mem_write(row - 0, shadow_mem[row][287:0]);
// initializing AUTOSARAMPDP_80X226_GL_M1_D2
for (row = 0; row < 80; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_80x514.ram_Inst_80X226_0_288.mem_write(row - 0, shadow_mem[row][513:288]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [513:0] data;
begin
// probing AUTOSARAMPDP_80X288_GL_M1_D2
 if (row >= 0 && row < 80) data[287:0] = r_sa_ram_rwsp_80x514.ram_Inst_80X288_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_80X226_GL_M1_D2
 if (row >= 0 && row < 80) data[513:288] = r_sa_ram_rwsp_80x514.ram_Inst_80X226_0_288.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
