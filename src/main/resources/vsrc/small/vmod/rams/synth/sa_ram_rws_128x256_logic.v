...
// ================================================================
// File Name: sa_ram_rws_128x256_logic.v
...
module sa_ram_rws_128x256_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_128X256_GL_M1_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_128X256_GL_M1_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_128X256_GL_M1_D2 ram_Inst_128X256 (
                                            .CLK (gated_clk_core)
                                          , .WADR_6 (wa_0_0[6])
                                          , .WADR_5 (wa_0_0[5])
                                          , .WADR_4 (wa_0_0[4])
...
//For bitEnd 255, only one piece AUTOSARAMPDP_128X256_GL_M1_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(7, 0, 0) testInst_Wa_reg_w0 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(7, 0, 0) testInst_Ra_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
