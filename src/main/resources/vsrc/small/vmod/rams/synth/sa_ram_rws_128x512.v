// sa_ram_rws_128x512: synthesizable model wrapper
...
// This wrapper consists of : 2 Ram cells: AUTOSARAMPDP_128X288_GL_M1_D2 AUTOSARAMPDP_128X224_GL_M1_D2 ;
...
sa_ram_rws_128x512_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rws_128x512 (
...
integer row;
begin
// initializing AUTOSARAMPDP_128X288_GL_M1_D2
for (row = 0; row < 128; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_128x512.ram_Inst_128X288_0_0.mem_write(row - 0, shadow_mem[row][287:0]);
// initializing AUTOSARAMPDP_128X224_GL_M1_D2
for (row = 0; row < 128; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_128x512.ram_Inst_128X224_0_288.mem_write(row - 0, shadow_mem[row][511:288]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [511:0] data;
begin
// probing AUTOSARAMPDP_128X288_GL_M1_D2
 if (row >= 0 && row < 128) data[287:0] = r_sa_ram_rws_128x512.ram_Inst_128X288_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_128X224_GL_M1_D2
 if (row >= 0 && row < 128) data[511:288] = r_sa_ram_rws_128x512.ram_Inst_128X224_0_288.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
