...
// ================================================================
// File Name: sa_ram_rwsp_160x65.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 1 Ram cells: AUTOSARAMPDP_160X65_GL_M2_D2 ;
...
sa_ram_rwsp_160x65_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_160x65 (
...
integer row;
begin
// initializing AUTOSARAMPDP_160X65_GL_M2_D2
for (row = 0; row < 160; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_160x65.ram_Inst_160X65.mem_write(row - 0, shadow_mem[row][64:0]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [64:0] data;
begin
// probing AUTOSARAMPDP_160X65_GL_M2_D2
 if (row >= 0 && row < 160) data[64:0] = r_sa_ram_rwsp_160x65.ram_Inst_160X65.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
