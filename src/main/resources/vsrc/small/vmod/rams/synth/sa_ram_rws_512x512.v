...
// ================================================================
// File Name: sa_ram_rws_512x512.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 8 Ram cells: AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X8_GL_M4_D2 ;
...
SA_BLKBOX_SRC0_X testInst_mbist_Wa_w0_7 (.Y(pre_mbist_Wa_w0_7));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_Wa_w0_7 (.Z(mbist_Wa_w0[7]), .A1(pre_mbist_Wa_w0_7), .A2(DFT_clamp) );
wire pre_mbist_Wa_w0_8;
SA_BLKBOX_SRC0_X testInst_mbist_Wa_w0_8 (.Y(pre_mbist_Wa_w0_8));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_Wa_w0_8 (.Z(mbist_Wa_w0[8]), .A1(pre_mbist_Wa_w0_8), .A2(DFT_clamp) );
...
SA_BLKBOX_SRC0_X testInst_mbist_we_w0_0_72 (.Y(pre_mbist_we_w0_0_72));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_we_w0_0_72 (.Z(mbist_we_w0_0_72), .A1(pre_mbist_we_w0_0_72), .A2(DFT_clamp) );
wire pre_mbist_we_w0_0_144;
SA_BLKBOX_SRC0_X testInst_mbist_we_w0_0_144 (.Y(pre_mbist_we_w0_0_144));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_we_w0_0_144 (.Z(mbist_we_w0_0_144), .A1(pre_mbist_we_w0_0_144), .A2(DFT_clamp) );
wire pre_mbist_we_w0_0_216;
SA_BLKBOX_SRC0_X testInst_mbist_we_w0_0_216 (.Y(pre_mbist_we_w0_0_216));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_we_w0_0_216 (.Z(mbist_we_w0_0_216), .A1(pre_mbist_we_w0_0_216), .A2(DFT_clamp) );
...
SA_BLKBOX_SRC0_X testInst_mbist_we_w0_0_360 (.Y(pre_mbist_we_w0_0_360));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_we_w0_0_360 (.Z(mbist_we_w0_0_360), .A1(pre_mbist_we_w0_0_360), .A2(DFT_clamp) );
wire pre_mbist_we_w0_0_432;
SA_BLKBOX_SRC0_X testInst_mbist_we_w0_0_432 (.Y(pre_mbist_we_w0_0_432));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_we_w0_0_432 (.Z(mbist_we_w0_0_432), .A1(pre_mbist_we_w0_0_432), .A2(DFT_clamp) );
wire pre_mbist_we_w0_0_504;
SA_BLKBOX_SRC0_X testInst_mbist_we_w0_0_504 (.Y(pre_mbist_we_w0_0_504));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_we_w0_0_504 (.Z(mbist_we_w0_0_504), .A1(pre_mbist_we_w0_0_504), .A2(DFT_clamp) );
...
SA_BLKBOX_SRC0_X testInst_mbist_Ra_r0_7 (.Y(pre_mbist_Ra_r0_7));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_Ra_r0_7 (.Z(mbist_Ra_r0[7]), .A1(pre_mbist_Ra_r0_7), .A2(DFT_clamp) );
wire pre_mbist_Ra_r0_8;
SA_BLKBOX_SRC0_X testInst_mbist_Ra_r0_8 (.Y(pre_mbist_Ra_r0_8));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_Ra_r0_8 (.Z(mbist_Ra_r0[8]), .A1(pre_mbist_Ra_r0_8), .A2(DFT_clamp) );
`ifndef FPGA
...
SA_BLKBOX_SRC0_X testInst_mbist_ce_r0_0_72 (.Y(pre_mbist_ce_r0_0_72));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_ce_r0_0_72 (.Z(mbist_ce_r0_0_72), .A1(pre_mbist_ce_r0_0_72), .A2(DFT_clamp) );
wire pre_mbist_ce_r0_0_144;
SA_BLKBOX_SRC0_X testInst_mbist_ce_r0_0_144 (.Y(pre_mbist_ce_r0_0_144));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_ce_r0_0_144 (.Z(mbist_ce_r0_0_144), .A1(pre_mbist_ce_r0_0_144), .A2(DFT_clamp) );
wire pre_mbist_ce_r0_0_216;
SA_BLKBOX_SRC0_X testInst_mbist_ce_r0_0_216 (.Y(pre_mbist_ce_r0_0_216));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_ce_r0_0_216 (.Z(mbist_ce_r0_0_216), .A1(pre_mbist_ce_r0_0_216), .A2(DFT_clamp) );
...
SA_BLKBOX_SRC0_X testInst_mbist_ce_r0_0_360 (.Y(pre_mbist_ce_r0_0_360));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_ce_r0_0_360 (.Z(mbist_ce_r0_0_360), .A1(pre_mbist_ce_r0_0_360), .A2(DFT_clamp) );
wire pre_mbist_ce_r0_0_432;
SA_BLKBOX_SRC0_X testInst_mbist_ce_r0_0_432 (.Y(pre_mbist_ce_r0_0_432));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_ce_r0_0_432 (.Z(mbist_ce_r0_0_432), .A1(pre_mbist_ce_r0_0_432), .A2(DFT_clamp) );
wire pre_mbist_ce_r0_0_504;
SA_BLKBOX_SRC0_X testInst_mbist_ce_r0_0_504 (.Y(pre_mbist_ce_r0_0_504));
SA_AN2D4PO4 UJ_DFTQUALIFIER_mbist_ce_r0_0_504 (.Z(mbist_ce_r0_0_504), .A1(pre_mbist_ce_r0_0_504), .A2(DFT_clamp) );
...
sa_ram_rws_512x512_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rws_512x512 (
...
integer row;
begin
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_0.mem_write(row - 0, shadow_mem[row][71:0]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_72.mem_write(row - 0, shadow_mem[row][143:72]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_144.mem_write(row - 0, shadow_mem[row][215:144]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_216.mem_write(row - 0, shadow_mem[row][287:216]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_288.mem_write(row - 0, shadow_mem[row][359:288]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_360.mem_write(row - 0, shadow_mem[row][431:360]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X72_0_432.mem_write(row - 0, shadow_mem[row][503:432]);
// initializing AUTOSARAMPDP_512X8_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x512.ram_Inst_512X8_0_504.mem_write(row - 0, shadow_mem[row][511:504]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [511:0] data;
begin
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[71:0] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[143:72] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_72.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[215:144] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_144.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[287:216] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_216.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[359:288] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_288.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[431:360] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_360.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[503:432] = r_sa_ram_rws_512x512.ram_Inst_512X72_0_432.mem_read(row - 0);
// probing AUTOSARAMPDP_512X8_GL_M4_D2
 if (row >= 0 && row < 512) data[511:504] = r_sa_ram_rws_512x512.ram_Inst_512X8_0_504.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
