...
// ================================================================
// File Name: sa_ram_rws_512x64_logic.v
...
module sa_ram_rws_512x64_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_512X64_GL_M4_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_512X64_GL_M4_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_512X64_GL_M4_D2 ram_Inst_512X64 (
                                          .CLK (gated_clk_core)
                                        , .WADR_8 (wa_0_0[8])
                                        , .WADR_7 (wa_0_0[7])
                                        , .WADR_6 (wa_0_0[6])
...
//For bitEnd 63, only one piece AUTOSARAMPDP_512X64_GL_M4_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(64, 0, 0) testInst_Data_reg_r0 (
