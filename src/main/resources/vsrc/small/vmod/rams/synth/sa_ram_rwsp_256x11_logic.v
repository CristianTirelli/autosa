...
// ================================================================
// File Name: sa_ram_rwsp_256x11_logic.v
...
module sa_ram_rwsp_256x11_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_256X11_GL_M4_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_256X11_GL_M4_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_256X11_GL_M4_D2 ram_Inst_256X11 (
                                          .CLK (gated_clk_core)
                                        , .WADR_7 (wa_0_0[7])
                                        , .WADR_6 (wa_0_0[6])
                                        , .WADR_5 (wa_0_0[5])
...
//For bitEnd 10, only one piece AUTOSARAMPDP_256X11_GL_M4_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(11, 0, 0) testInst_Data_reg_r0 (
