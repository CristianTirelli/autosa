...
// ================================================================
// File Name: sa_ram_rws_32x256_logic.v
...
module sa_ram_rws_32x256_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_32X256_GL_M1_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_32X256_GL_M1_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_32X256_GL_M1_D2 ram_Inst_32X256 (
                                          .CLK (gated_clk_core)
                                        , .WADR_4 (wa_0_0[4])
                                        , .WADR_3 (wa_0_0[3])
                                        , .WADR_2 (wa_0_0[2])
...
//For bitEnd 255, only one piece AUTOSARAMPDP_32X256_GL_M1_D2 in the column.
