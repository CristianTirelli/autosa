...
// ================================================================
// File Name: sa_ram_rws_256x64_logic.v
...
module sa_ram_rws_256x64_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_256X64_GL_M2_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_256X64_GL_M2_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_256X64_GL_M2_D2 ram_Inst_256X64 (
                                          .CLK (gated_clk_core)
                                        , .WADR_7 (wa_0_0[7])
                                        , .WADR_6 (wa_0_0[6])
                                        , .WADR_5 (wa_0_0[5])
...
//For bitEnd 63, only one piece AUTOSARAMPDP_256X64_GL_M2_D2 in the column.
