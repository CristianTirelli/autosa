...
// ================================================================
// File Name: sa_ram_rwsthp_19x80_logic.v
...
module sa_ram_rwsthp_19x80_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMDP_20X80_GL_M1_E2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMDP_20X80_GL_M1_E2 -------------
// Write Port Stuff -----
...
AUTOSARAMDP_20X80_GL_M1_E2 ram_Inst_19X80 (
...
//For bitEnd 79, only one piece AUTOSARAMDP_20X80_GL_M1_E2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(80, 0, 0) testInst_Data_reg_r0 (
