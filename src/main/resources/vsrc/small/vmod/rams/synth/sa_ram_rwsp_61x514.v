...
// ================================================================
// File Name: sa_ram_rwsp_61x514.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 2 Ram cells: AUTOSARAMPDP_64X288_GL_M1_D2 AUTOSARAMPDP_64X226_GL_M1_D2 ;
...
sa_ram_rwsp_61x514_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_61x514 (
...
for (row = 0; row < 61; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_61x514.ram_Inst_61X288_0_0.mem_write(row - 0, shadow_mem[row][287:0]);
// initializing AUTOSARAMPDP_64X226_GL_M1_D2
for (row = 0; row < 61; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_61x514.ram_Inst_61X226_0_288.mem_write(row - 0, shadow_mem[row][513:288]);
shadow_written = 'b0;
end
endtask
`endif
...
// probing AUTOSARAMPDP_64X288_GL_M1_D2
 if (row >= 0 && row < 61) data[287:0] = r_sa_ram_rwsp_61x514.ram_Inst_61X288_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_64X226_GL_M1_D2
 if (row >= 0 && row < 61) data[513:288] = r_sa_ram_rwsp_61x514.ram_Inst_61X226_0_288.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
