...
wire autosa_wg_gated_clk;
wire [20:0] reg2dp_atomics;
wire [4:0] reg2dp_batches;
wire [0:0] reg2dp_cosa_mode;
wire [2:0] reg2dp_cosa_x_stride_ext;
wire [2:0] reg2dp_cosa_y_stride_ext;
...
// Regfile
//==========================================================
SA_AUTOSA_CSC_regfile u_regfile (
  ...
  ,.reg2dp_cosa_x_stride_ext (reg2dp_cosa_x_stride_ext[2:0]) //|> w
  ,.reg2dp_cosa_y_stride_ext (reg2dp_cosa_y_stride_ext[2:0]) //|> w
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
  ...
  ,.autosa_core_ng_clk (autosa_core_clk) //|< i
  ,.autosa_wg_clk (autosa_wg_gated_clk) //|< w
  ,.reg2dp_op_en (reg2dp_op_en[0]) //|< w
  ,.reg2dp_cosa_mode (reg2dp_cosa_mode[0]) //|< w
  ,.reg2dp_batches (reg2dp_batches[4:0]) //|< w
  ,.reg2dp_proc_precision (reg2dp_proc_precision[1:0]) //|< w
...
// SLCG groups
//==========================================================
SA_AUTOSA_CSC_slcg u_slcg_op_0 (
...
SA_AUTOSA_CSC_slcg u_slcg_op_1 (
   .dla_clk_ovr_on_sync (dla_clk_ovr_on_sync) //|< i
  ,.global_clk_ovr_on_sync (global_clk_ovr_on_sync) //|< i
  ,.autosa_core_clk (autosa_core_clk) //|< i
  ,.autosa_core_rstn (autosa_core_rstn) //|< i
...
SA_AUTOSA_CSC_slcg u_slcg_op_2 (
   .dla_clk_ovr_on_sync (dla_clk_ovr_on_sync) //|< i
  ,.global_clk_ovr_on_sync (global_clk_ovr_on_sync) //|< i
  ,.autosa_core_clk (autosa_core_clk) //|< i
  ,.autosa_core_rstn (autosa_core_rstn) //|< i
...
SA_AUTOSA_CSC_slcg u_slcg_wg (
  ...
  ,.tmc2slcg_disable_clock_gating (tmc2slcg_disable_clock_gating) //|< i
  ,.autosa_core_gated_clk (autosa_wg_gated_clk) //|> w
  );
endmodule // SA_AUTOSA_csc
