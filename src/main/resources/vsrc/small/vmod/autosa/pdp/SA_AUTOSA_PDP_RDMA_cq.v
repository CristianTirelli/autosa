...
// fifogen -input_config_yaml ../../../../../../../socd/ip_chip_tools/1.0/sa_defs/public/fifogen/golden/tlit5/fifogen.yml -no_make_ram -no_make_ram -stdout -m SA_AUTOSA_PDP_RDMA_cq -clk_name autosa_core_clk -reset_name autosa_core_rstn -wr_pipebus ig2cq -rd_pipebus cq2eg -rd_reg -d 256 -w 18 -rand_none -ram ff [Chosen ram type: ff - fifogen_flops (user specified, thus no other ram type is allowed)]
...
SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18 ram (
...
//
assign wr_limit_muxed = `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_cq_wr_limit_override ? `EMU_FIFO_CFG.SA_AUTOSA_PDP_RDMA_cq_wr_limit : 9'd0;
`else
...
`endif
    ...
    if ( $test$plusargs( "SA_AUTOSA_PDP_RDMA_cq_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "SA_AUTOSA_PDP_RDMA_cq_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// set_boundary_optimization find(design, "SA_AUTOSA_PDP_RDMA_cq") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // SA_AUTOSA_PDP_RDMA_cq
//
// Flop-Based RAM
//
module SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18 (
      clk
    , pwrbus_ram_pd
    , di
    , we
...
vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra )
...
`endif // EMU
endmodule // SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18
// emulation model of flopram guts
//
`ifdef EMU
module vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [7:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18) }
// set_attribute { find (design, vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18] != {} } { set_attr preserve 1 [find / -subdesign vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18] }
endmodule // vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18
//vmw: Memory vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18
//vmw: Address-size 8
//vmw: Data-size 18
...
//vmw:
//qt: CELL vmw_SA_AUTOSA_PDP_RDMA_cq_flopram_rwsa_256x18
