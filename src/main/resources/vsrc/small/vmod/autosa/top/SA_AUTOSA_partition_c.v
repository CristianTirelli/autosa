...
// ================================================================
// File Name: SA_AUTOSA_partition_c.v
// ================================================================
// AUTOSA Open Source Project
// 
// Copyright(c) 2016 - 2017 NVIDIA Corporation.  Licensed under the
...
////////////////////////////////////////////////////////////////////////
// AUTOSA Partition C: Reset Sync //
////////////////////////////////////////////////////////////////////////
SA_AUTOSA_reset u_partition_c_reset (
...
// SLCG override
////////////////////////////////////////////////////////////////////////
SA_AUTOSA_sa_sync3d u_csc_dla_clk_ovr_on_sync (
   .clk (autosa_core_clk)
  ,.sync_i (autosa_clk_ovr_on)
  ,.sync_o (csc_dla_clk_ovr_on_sync)
  );
SA_AUTOSA_sa_sync3d u_cdma_dla_clk_ovr_on_sync (
   .clk (autosa_core_clk)
  ,.sync_i (autosa_clk_ovr_on)
  ,.sync_o (cdma_dla_clk_ovr_on_sync)
  );
//&Instance SA_AUTOSA_sa_sync3d u_dla_clk_ovr_on_sync;
//&Connect clk autosa_core_clk;
//&Connect sync_i autosa_clk_ovr_on;
//&Connect sync_o dla_clk_ovr_on_sync;
SA_AUTOSA_sa_sync3d_s u_global_csc_clk_ovr_on_sync (
   .clk (autosa_core_clk)
  ,.prst (autosa_core_rstn)
  ,.sync_i (global_clk_ovr_on)
  ,.sync_o (csc_global_clk_ovr_on_sync)
  );
SA_AUTOSA_sa_sync3d_s u_global_cdma_clk_ovr_on_sync (
   .clk (autosa_core_clk)
  ,.prst (autosa_core_rstn)
  ,.sync_i (global_clk_ovr_on)
  ,.sync_o (cdma_global_clk_ovr_on_sync)
  );
//&Instance SA_AUTOSA_sa_sync3d_s u_global_clk_ovr_on_sync;
//&Connect clk autosa_core_clk;
//&Connect prst autosa_core_rstn;
//&Connect sync_i global_clk_ovr_on;
//&Connect sync_o global_clk_ovr_on_sync;
////////////////////////////////////////////////////////////////////////
// AUTOSA Partition C: Convolution DMA //
////////////////////////////////////////////////////////////////////////
SA_AUTOSA_cdma u_SA_AUTOSA_cdma (
...
////////////////////////////////////////////////////////////////////////
// AUTOSA Partition C: Convolution Buffer //
////////////////////////////////////////////////////////////////////////
SA_AUTOSA_cbuf u_SA_AUTOSA_cbuf (
// .autosa_core_clk (autosa_core_clk)
// ,.autosa_core_rstn (autosa_core_rstn)
// ,.pwrbus_ram_pd (pwrbus_ram_pd)
// ,.cdma2buf_dat_wr_en (cdma2buf_dat_wr_en)
// //: my $dmaif=AUTOSA_DMAIF_BW;
// //: my $atmc=AUTOSA_MAC_ATOMIC_C_SIZE*AUTOSA_BPE;
// //: if($dmaif < $atmc) {
// //:     my $k = int(log(int($atmc/$dmaif))/log(2));
// //:     print qq(
// //:       ,.cdma2buf_dat_wr_addr          (cdma2buf_dat_wr_addr)
...
////////////////////////////////////////////////////////////////////////
// AUTOSA Partition C: Convolution Sequence Controller //
////////////////////////////////////////////////////////////////////////
SA_AUTOSA_csc u_SA_AUTOSA_csc (
   .autosa_core_clk (autosa_core_clk) //|< i
  ,.autosa_core_rstn (autosa_core_rstn) //|< w
...
////////////////////////////////////////////////////////////////////////
endmodule // SA_AUTOSA_partition_c
