...
wire   [2:0] c2_3_fu_199_p2;
reg   [2:0] c2_3_reg_237;
...
reg    ap_block_state1;
wire   [0:0] icmp_ln649_fu_177_p2;
reg   [0:0] intra_trans_en_1_reg_80;
wire   [0:0] icmp_ln648_fu_165_p2;
wire   [0:0] icmp_ln650_fu_193_p2;
reg   [2:0] c1_reg_93;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_1_phi_fu_108_p4 == 1'd1) & (icmp_ln650_fu_193_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_1_phi_fu_108_p4 == 1'd0) & (icmp_ln650_fu_193_p2 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_1_phi_fu_108_p4 == 1'd1) & (icmp_ln650_fu_193_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_1_phi_fu_108_p4 == 1'd0) & (icmp_ln650_fu_193_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln648_fu_165_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln649_fu_177_p2 == 1'd0))) begin
        arb_1_reg_104 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        c0_fu_54 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln649_fu_177_p2 == 1'd1))) begin
        c0_fu_54 <= c0_2_reg_221;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln650_fu_193_p2 == 1'd1))) begin
        c1_reg_93 <= c1_1_reg_229;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln648_fu_165_p2 == 1'd0))) begin
        c1_reg_93 <= 3'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln649_fu_177_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln648_fu_165_p2 == 1'd0))) begin
...
assign c2_3_fu_199_p2 = (c2_reg_129 + 3'd1);
...
assign icmp_ln648_fu_165_p2 = ((c0_fu_54 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln649_fu_177_p2 = ((c1_reg_93 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln650_fu_193_p2 = ((c2_reg_129 == 3'd4) ? 1'b1 : 1'b0);
