...
module kernel0_C_drain_IO_L1_out_Pipeline_VITIS_LOOP_932_4_VITIS_LOOP_934_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [4:0] indvar_flatten13_fu_44;
wire   [4:0] add_ln932_fu_76_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln932_fu_70_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten13_fu_44 <= add_ln932_fu_76_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten13_fu_44 <= 5'd0;
        end
    end
end

always @ (*) begin
    if (((icmp_ln932_fu_70_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_indvar_flatten13_load = indvar_flatten13_fu_44;
    end
end
...
assign add_ln932_fu_76_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 5'd1);
...
assign icmp_ln932_fu_70_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 5'd16) ? 1'b1 : 1'b0);

endmodule //kernel0_C_drain_IO_L1_out_Pipeline_VITIS_LOOP_932_4_VITIS_LOOP_934_5
