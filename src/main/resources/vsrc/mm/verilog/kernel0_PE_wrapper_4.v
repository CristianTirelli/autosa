...
module kernel0_PE_wrapper_4 (
        ...
        fifo_A_PE_1_0_empty_n,
        fifo_A_PE_1_0_read,
        fifo_A_PE_1_1_din,
        fifo_A_PE_1_1_num_data_valid,
        fifo_A_PE_1_1_fifo_cap,
        fifo_A_PE_1_1_full_n,
        fifo_A_PE_1_1_write,
        fifo_B_PE_1_0_dout,
        fifo_B_PE_1_0_num_data_valid,
        fifo_B_PE_1_0_fifo_cap,
        fifo_B_PE_1_0_empty_n,
        fifo_B_PE_1_0_read,
        fifo_B_PE_2_0_din,
        fifo_B_PE_2_0_num_data_valid,
        fifo_B_PE_2_0_fifo_cap,
        fifo_B_PE_2_0_full_n,
        fifo_B_PE_2_0_write,
        fifo_C_drain_PE_1_0_din,
        fifo_C_drain_PE_1_0_num_data_valid,
        fifo_C_drain_PE_1_0_fifo_cap,
        fifo_C_drain_PE_1_0_full_n,
        fifo_C_drain_PE_1_0_write
);
...
output   start_out;
output   start_write;
input  [63:0] fifo_A_PE_1_0_dout;
input  [2:0] fifo_A_PE_1_0_num_data_valid;
input  [2:0] fifo_A_PE_1_0_fifo_cap;
input   fifo_A_PE_1_0_empty_n;
output   fifo_A_PE_1_0_read;
output  [63:0] fifo_A_PE_1_1_din;
input  [2:0] fifo_A_PE_1_1_num_data_valid;
input  [2:0] fifo_A_PE_1_1_fifo_cap;
input   fifo_A_PE_1_1_full_n;
output   fifo_A_PE_1_1_write;
input  [63:0] fifo_B_PE_1_0_dout;
input  [2:0] fifo_B_PE_1_0_num_data_valid;
input  [2:0] fifo_B_PE_1_0_fifo_cap;
input   fifo_B_PE_1_0_empty_n;
output   fifo_B_PE_1_0_read;
output  [63:0] fifo_B_PE_2_0_din;
input  [2:0] fifo_B_PE_2_0_num_data_valid;
input  [2:0] fifo_B_PE_2_0_fifo_cap;
input   fifo_B_PE_2_0_full_n;
output   fifo_B_PE_2_0_write;
output  [31:0] fifo_C_drain_PE_1_0_din;
input  [2:0] fifo_C_drain_PE_1_0_num_data_valid;
input  [2:0] fifo_C_drain_PE_1_0_fifo_cap;
input   fifo_C_drain_PE_1_0_full_n;
output   fifo_C_drain_PE_1_0_write;

reg ap_done;
reg ap_idle;
reg start_write;
reg fifo_A_PE_1_0_read;
reg fifo_A_PE_1_1_write;
reg fifo_B_PE_1_0_read;
reg fifo_B_PE_2_0_write;
reg fifo_C_drain_PE_1_0_write;
...
kernel0_PE grp_PE_fu_30(
    ...
    .fifo_B_PE_2_1_full_n(fifo_B_PE_2_0_full_n),
    ...
    .fifo_A_PE_1_2_full_n(fifo_A_PE_1_1_full_n),
    ...
    .fifo_C_drain_PE_1_1_full_n(fifo_C_drain_PE_1_0_full_n),
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_A_PE_1_0_read = grp_PE_fu_30_fifo_A_PE_1_12_read;
    end else begin
        fifo_A_PE_1_0_read = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_A_PE_1_1_write = grp_PE_fu_30_fifo_A_PE_1_2_write;
    end else begin
        fifo_A_PE_1_1_write = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_B_PE_1_0_read = grp_PE_fu_30_fifo_B_PE_1_1_read;
    end else begin
        fifo_B_PE_1_0_read = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_B_PE_2_0_write = grp_PE_fu_30_fifo_B_PE_2_1_write;
    end else begin
        fifo_B_PE_2_0_write = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_C_drain_PE_1_0_write = grp_PE_fu_30_fifo_C_drain_PE_1_1_write;
    end else begin
        fifo_C_drain_PE_1_0_write = 1'b0;
    end
end
...
assign fifo_A_PE_1_1_din = grp_PE_fu_30_fifo_A_PE_1_2_din;

assign fifo_B_PE_2_0_din = grp_PE_fu_30_fifo_B_PE_2_1_din;

assign fifo_C_drain_PE_1_0_din = grp_PE_fu_30_fifo_C_drain_PE_1_1_din;

assign grp_PE_fu_30_ap_start = grp_PE_fu_30_ap_start_reg;

assign start_out = real_start;

endmodule //kernel0_PE_wrapper_4
