...
input  [2:0] fifo_C_drain_C_drain_IO_L3_out_serialize_num_data_valid;
input  [2:0] fifo_C_drain_C_drain_IO_L3_out_serialize_fifo_cap;
...
reg    gmem_C_blk_n_B;
reg   [0:0] icmp_ln1197_1_reg_220;
reg   [0:0] icmp_ln1197_1_reg_220_pp0_iter2_reg;
reg    C_blk_n;
...
wire   [0:0] icmp_ln1197_fu_136_p2;
reg   [0:0] icmp_ln1197_reg_216_pp0_iter1_reg;
wire   [0:0] icmp_ln1197_1_fu_148_p2;
reg   [0:0] icmp_ln1197_1_reg_220_pp0_iter1_reg;
wire  signed [63:0] sext_ln1197_fu_169_p1;
reg  signed [63:0] sext_ln1197_reg_224;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_301)) begin
        if ((icmp_ln1197_fu_136_p2 == 1'd0)) begin
            i_fu_76 <= add_ln1197_fu_142_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln1197_1_reg_220 <= icmp_ln1197_1_fu_148_p2;
        icmp_ln1197_1_reg_220_pp0_iter1_reg <= icmp_ln1197_1_reg_220;
        icmp_ln1197_1_reg_220_pp0_iter2_reg <= icmp_ln1197_1_reg_220_pp0_iter1_reg;
        icmp_ln1197_reg_216 <= icmp_ln1197_fu_136_p2;
        icmp_ln1197_reg_216_pp0_iter1_reg <= icmp_ln1197_reg_216;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        sext_ln1197_reg_224 <= sext_ln1197_fu_169_p1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (first_iter_0_reg_116 == 1'd1))) begin
        C_blk_n = C_empty_n;
    end else begin
        C_blk_n = 1'b1;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_subdone) & (icmp_ln1197_reg_216 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1197_reg_216_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage3) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage1) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage2) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage3_11001) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage2_11001) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (first_iter_0_reg_116 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln1197_1_reg_220_pp0_iter2_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln1197_1_reg_220_pp0_iter2_reg == 1'd1))) begin
...
assign add_ln1197_fu_142_p2 = (ap_sig_allocacmp_i_1 + 9'd1);
...
always @ (*) begin
    ap_block_pp0_stage1_11001 = (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage1_iter0)) | ((m_axi_gmem_C_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage1_iter0)) | ((m_axi_gmem_C_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage2_11001 = (((ap_enable_reg_pp0_iter0 == 1'b1) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage2_iter0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state11_pp0_stage2_iter2)));
end

always @ (*) begin
    ap_block_pp0_stage2_subdone = (((ap_enable_reg_pp0_iter0 == 1'b1) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage2_iter0))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state11_pp0_stage2_iter2)));
end
...
always @ (*) begin
    ap_block_state11_pp0_stage2_iter2 = ((icmp_ln1197_1_reg_220_pp0_iter2_reg == 1'd1) & (m_axi_gmem_C_BVALID == 1'b0));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((icmp_ln1197_reg_216 == 1'd0) & (fifo_C_drain_C_drain_IO_L3_out_serialize_empty_n == 1'b0)) | ((1'b0 == C_empty_n) & (ap_predicate_op31_read_state2 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage2_iter0 = ((icmp_ln1197_reg_216 == 1'd0) & (fifo_C_drain_C_drain_IO_L3_out_serialize_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage3_iter0 = ((icmp_ln1197_reg_216 == 1'd0) & (fifo_C_drain_C_drain_IO_L3_out_serialize_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_condition_400 = ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1197_reg_216 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_predicate_op31_read_state2 = ((icmp_ln1197_reg_216 == 1'd0) & (first_iter_0_reg_116 == 1'd1));
end

always @ (*) begin
    ap_predicate_op37_writereq_state3 = ((icmp_ln1197_reg_216 == 1'd0) & (first_iter_0_reg_116 == 1'd1));
end

assign icmp_ln1197_1_fu_148_p2 = ((add_ln1197_fu_142_p2 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln1197_fu_136_p2 = ((ap_sig_allocacmp_i_1 == 9'd256) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_C_AWADDR = sext_ln1197_reg_224;
...
assign sext_ln1197_fu_169_p1 = $signed(trunc_ln_fu_159_p4);
