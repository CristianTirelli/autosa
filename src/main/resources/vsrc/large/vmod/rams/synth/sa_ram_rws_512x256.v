...
// ================================================================
// File Name: sa_ram_rws_512x256.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 4 Ram cells: AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X40_GL_M4_D2 ;
...
sa_ram_rws_512x256_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rws_512x256 (
...
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x256.ram_Inst_512X72_0_0.mem_write(row - 0, shadow_mem[row][71:0]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x256.ram_Inst_512X72_0_72.mem_write(row - 0, shadow_mem[row][143:72]);
// initializing AUTOSARAMPDP_512X72_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x256.ram_Inst_512X72_0_144.mem_write(row - 0, shadow_mem[row][215:144]);
// initializing AUTOSARAMPDP_512X40_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x256.ram_Inst_512X40_0_216.mem_write(row - 0, shadow_mem[row][255:216]);
shadow_written = 'b0;
end
endtask
`endif
...
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[71:0] = r_sa_ram_rws_512x256.ram_Inst_512X72_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[143:72] = r_sa_ram_rws_512x256.ram_Inst_512X72_0_72.mem_read(row - 0);
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[215:144] = r_sa_ram_rws_512x256.ram_Inst_512X72_0_144.mem_read(row - 0);
// probing AUTOSARAMPDP_512X40_GL_M4_D2
 if (row >= 0 && row < 512) data[255:216] = r_sa_ram_rws_512x256.ram_Inst_512X40_0_216.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
