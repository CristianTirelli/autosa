// sa_ram_rwsp_256x14: synthesizable model wrapper
...
// This wrapper consists of : 1 Ram cells: AUTOSARAMPDP_256X14_GL_M4_D2 ;
...
sa_ram_rwsp_256x14_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_256x14 (
...
integer row;
begin
// initializing AUTOSARAMPDP_256X14_GL_M4_D2
for (row = 0; row < 256; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_256x14.ram_Inst_256X14.mem_write(row - 0, shadow_mem[row][13:0]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [13:0] data;
begin
// probing AUTOSARAMPDP_256X14_GL_M4_D2
 if (row >= 0 && row < 256) data[13:0] = r_sa_ram_rwsp_256x14.ram_Inst_256X14.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
