...
// ================================================================
// File Name: sa_ram_rwsp_61x64_logic.v
...
module sa_ram_rwsp_61x64_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_64X64_GL_M1_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_64X64_GL_M1_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_64X64_GL_M1_D2 ram_Inst_61X64 (
                                        .CLK (gated_clk_core)
                                      , .WADR_5 (wa_0_0[5])
                                      , .WADR_4 (wa_0_0[4])
                                      , .WADR_3 (wa_0_0[3])
...
//For bitEnd 63, only one piece AUTOSARAMPDP_64X64_GL_M1_D2 in the column.
