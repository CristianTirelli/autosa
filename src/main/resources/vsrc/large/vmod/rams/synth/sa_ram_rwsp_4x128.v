// sa_ram_rwsp_4x128: synthesizable model wrapper
...
SA_BLKBOX_SRC0_X testInst_scan_ramcen (.Y(pre_scan_ramcen));
SA_AN2D4PO4 UJ_DFTQUALIFIER_scan_ramcen (.Z(scan_ramcen), .A1(pre_scan_ramcen), .A2(DFT_clamp) );
wire pre_scan_en;
...
sa_ram_rwsp_4x128_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_4x128 (
...
if (shadow_written[0]) force r_sa_ram_rwsp_4x128.Wdata_row0 = shadow_mem[0][127:0];
if (shadow_written[0]) force r_sa_ram_rwsp_4x128.latchNet_G_en0 = 1'b1;
if (shadow_written[1]) force r_sa_ram_rwsp_4x128.Wdata_row1 = shadow_mem[1][127:0];
if (shadow_written[1]) force r_sa_ram_rwsp_4x128.latchNet_G_en1 = 1'b1;
if (shadow_written[2]) force r_sa_ram_rwsp_4x128.Wdata_row2 = shadow_mem[2][127:0];
if (shadow_written[2]) force r_sa_ram_rwsp_4x128.latchNet_G_en2 = 1'b1;
if (shadow_written[3]) force r_sa_ram_rwsp_4x128.Wdata_row3 = shadow_mem[3][127:0];
if (shadow_written[3]) force r_sa_ram_rwsp_4x128.latchNet_G_en3 = 1'b1;
#1;
// releasing enables for Latch_Array
release r_sa_ram_rwsp_4x128.latchNet_G_en0;
release r_sa_ram_rwsp_4x128.latchNet_G_en1;
release r_sa_ram_rwsp_4x128.latchNet_G_en2;
release r_sa_ram_rwsp_4x128.latchNet_G_en3;
#1;
// releasing data inputs for Latch_Array
release r_sa_ram_rwsp_4x128.Wdata_row0;
release r_sa_ram_rwsp_4x128.Wdata_row1;
release r_sa_ram_rwsp_4x128.Wdata_row2;
release r_sa_ram_rwsp_4x128.Wdata_row3;
shadow_written = 'b0;
end
endtask
`endif
...
begin
// probing Latch_Array
if (row == 0) data[127:0] = r_sa_ram_rwsp_4x128.LatchArray_row0;
if (row == 1) data[127:0] = r_sa_ram_rwsp_4x128.LatchArray_row1;
if (row == 2) data[127:0] = r_sa_ram_rwsp_4x128.LatchArray_row2;
if (row == 3) data[127:0] = r_sa_ram_rwsp_4x128.LatchArray_row3;
    probe_mem_val = data;
end
endfunction
`endif
