...
// ================================================================
// File Name: sa_ram_rws_512x512_logic.v
...
module sa_ram_rws_512x512_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
wire updateDR_sync;
sa_sync2d_c_pp updateDR_synchronizer (.d(updateDR), .clk(la_bist_clkw0), .q(updateDR_sync), .clr_(mbist_ramaccess_rst_));
...
SA_CKLNQD12PO4 CLK_GATE_clk (.Q(dft_rst_gated_clk), .CP(clk), .E(mbist_ramaccess_rst_), .TE(scan_en));
sa_sync2d_c_pp debug_mode_synchronizer (.d(debug_mode), .clk(dft_rst_gated_clk), .q(debug_mode_sync), .clr_(mbist_ramaccess_rst_));
reg [8:0] Ra_array_reg_r0;
wire mbist_en_r;
// hardcode mbist_en_r stdcell flop to avoid x bash recoverability issue described in bug 1803479 comment #7
p_SA_SDFCNQD1PO4 mbist_en_flop(.D(mbist_en_sync), .CP(dft_rst_gated_clk), .Q(mbist_en_r), .CDN(mbist_ramaccess_rst_));
// Declare the Data_reg signal beforehand
wire [511:0] Data_reg_r0;
// Data out bus for read port r0 for Output Mux
wire [511:0] r0_OutputMuxDataOut;
SA_CKLNQD12PO4 UJ_la_bist_clkw0_gate (.Q(la_bist_clkw0), .CP(clk), .E(mbist_en_r | debug_mode_sync), .TE(scan_en));
// Write enable bus
wire we_0_0;
// Read enable bus
wire re_0_0;
...
SA_CKLNQD12PO4 UJ_clk_gate_core_0_0 (.Q(gated_clk_core_0_0), .CP(clk), .E(clk_en_core_0_0), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_72 = (re_0_72 | (|we_0_72));
wire gated_clk_core_0_72;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_72 (.Q(gated_clk_core_0_72), .CP(clk), .E(clk_en_core_0_72), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_144 = (re_0_144 | (|we_0_144));
wire gated_clk_core_0_144;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_144 (.Q(gated_clk_core_0_144), .CP(clk), .E(clk_en_core_0_144), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_216 = (re_0_216 | (|we_0_216));
wire gated_clk_core_0_216;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_216 (.Q(gated_clk_core_0_216), .CP(clk), .E(clk_en_core_0_216), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_288 = (re_0_288 | (|we_0_288));
wire gated_clk_core_0_288;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_288 (.Q(gated_clk_core_0_288), .CP(clk), .E(clk_en_core_0_288), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_360 = (re_0_360 | (|we_0_360));
wire gated_clk_core_0_360;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_360 (.Q(gated_clk_core_0_360), .CP(clk), .E(clk_en_core_0_360), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_432 = (re_0_432 | (|we_0_432));
wire gated_clk_core_0_432;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_432 (.Q(gated_clk_core_0_432), .CP(clk), .E(clk_en_core_0_432), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_504 = (re_0_504 | (|we_0_504));
wire gated_clk_core_0_504;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_504 (.Q(gated_clk_core_0_504), .CP(clk), .E(clk_en_core_0_504), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire shiftDR_en;
...
// ------------------ START PIECE ----------------------------------
// Suffix _0_0 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_72 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
assign re_0_72 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_144 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
assign re_0_144 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_216 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
assign re_0_216 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
assign re_0_288 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_360 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
assign re_0_360 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_432 : Piece AUTOSARAMPDP_512X72_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
assign re_0_432 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_504 : Piece AUTOSARAMPDP_512X8_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_0 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_0 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_72 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_72 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_144 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_144 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_216 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_216 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_288 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_360 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_360 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X72_GL_M4_D2_0_432 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X72_GL_M4_D2 ram_Inst_512X72_0_432 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X8_GL_M4_D2_0_504 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X8_GL_M4_D2 ram_Inst_512X8_0_504 (
...
//For bitEnd 71, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
...
//For bitEnd 143, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 215, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 287, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 359, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 431, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 503, only one piece AUTOSARAMPDP_512X72_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 511, only one piece AUTOSARAMPDP_512X8_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_LNQD1PO4 testInst_ram_access_lockup (
                   .Q(SO_int_net),
                   .D(Data_reg_SO_r0),
                   .EN(la_bist_clkw0));
`endif
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_511_256 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_255_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
sa_assert_no_x #(1,1,0," Try Reading Ram when clock is x for read port r0") _clk_x_test_read (clk, sim_reset_, ((disable_clk_x_test===1'b0) && (|re===1'b1 )), clk);
sa_assert_no_x #(1,1,0," Try Writing Ram when clock is x for write port w0") _clk_x_test_write (clk, sim_reset_, ((disable_clk_x_test===1'b0) && (|we===1'b1)), clk);
reg [512-1:0] written;
...
sa_assert_never #(0, 0, "Power bus cannot be X when read/write enable is set") _pwrbus_assertion_not_x_while_active_we ( we, sim_reset_ && !pwrbus_assertion_not_x_while_active, ^pwrbus_ram_pd === 1'bx);
sa_assert_never #(0, 0, "Power bus cannot be X when read/write enable is set") _pwrbus_assertion_not_x_while_active_re ( re, sim_reset_ && !pwrbus_assertion_not_x_while_active, ^pwrbus_ram_pd === 1'bx);
`endif
`endif
// submodule done
endmodule
