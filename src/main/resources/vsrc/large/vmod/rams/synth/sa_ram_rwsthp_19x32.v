...
// ================================================================
// File Name: sa_ram_rwsthp_19x32.v
`timescale 1ns / 10ps
...
`ifdef RAMGEN_AVF_PRINTS
 `define SA_Functional_safety_liveness_logging_enabled
`endif
`endif
wire [7:0] sleep_en = pwrbus_ram_pd[7:0];
wire ret_en = pwrbus_ram_pd[8];
integer l;
`ifdef SA_Functional_safety_liveness_logging_enabled
time liveness[18:0];
...
sa_assert_never #(0,0,"clobbered high") clobbered_high (clk,sim_reset_, (dout_ram_clobbered == 1'b1));
`endif
`endif // SYNTHESIS 
`endif // ASSERT_ON
`ifdef ASSERT_ON
...
$display ("sa_ram %m: size 608 bits, AVF liveness %d", average);
$display ("sa_ram %m: AVF ratioRW %f, totalWrites %d, totalReads %d", ratio_rw, sum_wrs, sum_rds);
end
endtask
`endif
`ifdef GCS_COMPILE
