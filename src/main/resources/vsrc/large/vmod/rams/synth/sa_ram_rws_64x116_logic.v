...
// ================================================================
// File Name: sa_ram_rws_64x116_logic.v
...
module sa_ram_rws_64x116_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_64X116_GL_M1_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_64X116_GL_M1_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_64X116_GL_M1_D2 ram_Inst_64X116 (
                                          .CLK (gated_clk_core)
                                        , .WADR_5 (wa_0_0[5])
                                        , .WADR_4 (wa_0_0[4])
                                        , .WADR_3 (wa_0_0[3])
...
//For bitEnd 115, only one piece AUTOSARAMPDP_64X116_GL_M1_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(116, 0, 0) testInst_Data_reg_r0 (
