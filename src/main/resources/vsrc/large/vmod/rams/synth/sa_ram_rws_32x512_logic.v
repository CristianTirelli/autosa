...
// ================================================================
// File Name: sa_ram_rws_32x512_logic.v
...
module sa_ram_rws_32x512_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_32X224_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 31 Addressrange: [4:0]
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_32X224_GL_M1_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_32X224_GL_M1_D2 ram_Inst_32X224_0_288 (
...
//For bitEnd 511, only one piece AUTOSARAMPDP_32X224_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
