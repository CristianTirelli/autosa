// sa_ram_rwsp_8x257: synthesizable model core
...
module sa_ram_rwsp_8x257_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMDP_8X258_GL_M1_E2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMDP_8X258_GL_M1_E2 -------------
// Write Port Stuff -----
...
AUTOSARAMDP_8X258_GL_M1_E2 ram_Inst_8X258 (
...
//For bitEnd 256, only one piece AUTOSARAMDP_8X258_GL_M1_E2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(3, 0, 0) testInst_Wa_reg_w0 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(3, 0, 0) testInst_Ra_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
