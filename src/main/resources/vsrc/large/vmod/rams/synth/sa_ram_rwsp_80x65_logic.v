...
// ================================================================
// File Name: sa_ram_rwsp_80x65_logic.v
...
module sa_ram_rwsp_80x65_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_80X66_GL_M1_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_80X66_GL_M1_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_80X66_GL_M1_D2 ram_Inst_80X66 (
                                        .CLK (gated_clk_core)
                                      , .WADR_6 (wa_0_0[6])
                                      , .WADR_5 (wa_0_0[5])
                                      , .WADR_4 (wa_0_0[4])
...
//For bitEnd 64, only one piece AUTOSARAMPDP_80X66_GL_M1_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(66, 0, 0) testInst_Data_reg_r0 (
