...
// ================================================================
// File Name: sa_ram_rws_64x1088_logic.v
...
module sa_ram_rws_64x1088_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
SA_CKLNQD12PO4 UJ_clk_gate_core_0_576 (.Q(gated_clk_core_0_576), .CP(clk), .E(clk_en_core_0_576), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire clk_en_core_0_864 = (re_0_864 | (|we_0_864));
wire gated_clk_core_0_864;
SA_CKLNQD12PO4 UJ_clk_gate_core_0_864 (.Q(gated_clk_core_0_864), .CP(clk), .E(clk_en_core_0_864), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire shiftDR_en;
...
// ------------------ START PIECE ----------------------------------
// Suffix _0_0 : Piece AUTOSARAMPDP_64X288_GL_M1_D2 (RamCell)
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_64X288_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 63 Addressrange: [5:0]
...
assign re_0_288 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_576 : Piece AUTOSARAMPDP_64X288_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 63 Addressrange: [5:0]
...
assign re_0_576 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_864 : Piece AUTOSARAMPDP_64X224_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 63 Addressrange: [5:0]
...
// ----------------- begin Ram Cell AUTOSARAMPDP_64X288_GL_M1_D2_0_0 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_64X288_GL_M1_D2 ram_Inst_64X288_0_0 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_64X288_GL_M1_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_64X288_GL_M1_D2 ram_Inst_64X288_0_288 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_64X288_GL_M1_D2_0_576 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_64X288_GL_M1_D2 ram_Inst_64X288_0_576 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_64X224_GL_M1_D2_0_864 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_64X224_GL_M1_D2 ram_Inst_64X224_0_864 (
...
//For bitEnd 287, only one piece AUTOSARAMPDP_64X288_GL_M1_D2 in the column.
...
//For bitEnd 575, only one piece AUTOSARAMPDP_64X288_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 863, only one piece AUTOSARAMPDP_64X288_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 1087, only one piece AUTOSARAMPDP_64X224_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(6, 0, 0) testInst_Wa_reg_w0 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(1, 0, 0) testInst_re_reg_r0_0_576 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(muxed_re_r0_0_576), .Q(re_0_576_q),
            .scanin(re_reg_SO_r0_0_288), .scanout(re_reg_SO_r0_0_576) );
SA_ScanShareSel_JTAG_reg_ext_cg #(1, 0, 0) testInst_re_reg_r0_0_864 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_1087_832 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_831_576 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_575_320 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_319_64 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[319:64]), .Q(Data_reg_r0_Q[319:64]),
            .scanin(so_Data_reg_r0_575_320), .scanout(so_Data_reg_r0_319_64) );
SA_ScanShareSel_JTAG_reg_ext_cg #(64, 0, 0) testInst_Data_reg_r0_63_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
