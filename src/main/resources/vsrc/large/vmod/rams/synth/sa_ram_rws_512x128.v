// sa_ram_rws_512x128: synthesizable model wrapper
...
// This wrapper consists of : 2 Ram cells: AUTOSARAMPDP_512X72_GL_M4_D2 AUTOSARAMPDP_512X56_GL_M4_D2 ;
...
sa_ram_rws_512x128_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rws_512x128 (
...
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x128.ram_Inst_512X72_0_0.mem_write(row - 0, shadow_mem[row][71:0]);
// initializing AUTOSARAMPDP_512X56_GL_M4_D2
for (row = 0; row < 512; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_512x128.ram_Inst_512X56_0_72.mem_write(row - 0, shadow_mem[row][127:72]);
shadow_written = 'b0;
end
endtask
`endif
...
// probing AUTOSARAMPDP_512X72_GL_M4_D2
 if (row >= 0 && row < 512) data[71:0] = r_sa_ram_rws_512x128.ram_Inst_512X72_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_512X56_GL_M4_D2
 if (row >= 0 && row < 512) data[127:72] = r_sa_ram_rws_512x128.ram_Inst_512X56_0_72.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
