...
// ================================================================
// File Name: sa_ram_rws_64x1024_logic.v
...
module sa_ram_rws_64x1024_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign re_0_576 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_864 : Piece AUTOSARAMPDP_64X160_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 63 Addressrange: [5:0]
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_64X160_GL_M1_D2_0_864 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_64X160_GL_M1_D2 ram_Inst_64X160_0_864 (
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 1023, only one piece AUTOSARAMPDP_64X160_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_1023_768 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_767_512 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
