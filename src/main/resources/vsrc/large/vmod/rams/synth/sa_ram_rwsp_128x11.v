...
// ================================================================
// File Name: sa_ram_rwsp_128x11.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 1 Ram cells: AUTOSARAMDP_128X11_GL_M2_E2 ;
...
sa_ram_rwsp_128x11_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_128x11 (
...
integer row;
begin
// initializing AUTOSARAMDP_128X11_GL_M2_E2
for (row = 0; row < 128; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_128x11.ram_Inst_128X11.mem_write(row - 0, shadow_mem[row][10:0]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [10:0] data;
begin
// probing AUTOSARAMDP_128X11_GL_M2_E2
 if (row >= 0 && row < 128) data[10:0] = r_sa_ram_rwsp_128x11.ram_Inst_128X11.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
