...
// This wrapper consists of : 3 Ram cells: AUTOSARAMPDP_32X288_GL_M1_D2 AUTOSARAMPDP_32X288_GL_M1_D2 AUTOSARAMPDP_32X192_GL_M1_D2 ;
...
sa_ram_rws_32x768_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rws_32x768 (
...
integer row;
begin
// initializing AUTOSARAMPDP_32X288_GL_M1_D2
for (row = 0; row < 32; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_32x768.ram_Inst_32X288_0_0.mem_write(row - 0, shadow_mem[row][287:0]);
// initializing AUTOSARAMPDP_32X288_GL_M1_D2
for (row = 0; row < 32; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_32x768.ram_Inst_32X288_0_288.mem_write(row - 0, shadow_mem[row][575:288]);
// initializing AUTOSARAMPDP_32X192_GL_M1_D2
for (row = 0; row < 32; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rws_32x768.ram_Inst_32X192_0_576.mem_write(row - 0, shadow_mem[row][767:576]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [767:0] data;
begin
// probing AUTOSARAMPDP_32X288_GL_M1_D2
 if (row >= 0 && row < 32) data[287:0] = r_sa_ram_rws_32x768.ram_Inst_32X288_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_32X288_GL_M1_D2
 if (row >= 0 && row < 32) data[575:288] = r_sa_ram_rws_32x768.ram_Inst_32X288_0_288.mem_read(row - 0);
// probing AUTOSARAMPDP_32X192_GL_M1_D2
 if (row >= 0 && row < 32) data[767:576] = r_sa_ram_rws_32x768.ram_Inst_32X192_0_576.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
