...
// ================================================================
// File Name: sa_ram_rwst_256x8_logic.v
...
module sa_ram_rwst_256x8_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMDP_256X8_GL_M2_E2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMDP_256X8_GL_M2_E2 -------------
// Write Port Stuff -----
...
AUTOSARAMDP_256X8_GL_M2_E2 ram_Inst_256X8 (
...
//For bitEnd 7, only one piece AUTOSARAMDP_256X8_GL_M2_E2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(8, 0, 0) testInst_Data_reg_r0 (
