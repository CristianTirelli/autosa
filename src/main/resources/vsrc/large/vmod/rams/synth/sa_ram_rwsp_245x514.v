...
// ================================================================
// File Name: sa_ram_rwsp_245x514.v
`timescale 1ns / 10ps
...
// This wrapper consists of : 4 Ram cells: AUTOSARAMPDP_248X144_GL_M2_D2 AUTOSARAMPDP_248X144_GL_M2_D2 AUTOSARAMPDP_248X144_GL_M2_D2 AUTOSARAMPDP_248X82_GL_M2_D2 ;
...
sa_ram_rwsp_245x514_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_sa_ram_rwsp_245x514 (
...
integer row;
begin
// initializing AUTOSARAMPDP_248X144_GL_M2_D2
for (row = 0; row < 245; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_245x514.ram_Inst_245X144_0_0.mem_write(row - 0, shadow_mem[row][143:0]);
// initializing AUTOSARAMPDP_248X144_GL_M2_D2
for (row = 0; row < 245; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_245x514.ram_Inst_245X144_0_144.mem_write(row - 0, shadow_mem[row][287:144]);
// initializing AUTOSARAMPDP_248X144_GL_M2_D2
for (row = 0; row < 245; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_245x514.ram_Inst_245X144_0_288.mem_write(row - 0, shadow_mem[row][431:288]);
// initializing AUTOSARAMPDP_248X82_GL_M2_D2
for (row = 0; row < 245; row = row + 1)
 if (shadow_written[row]) r_sa_ram_rwsp_245x514.ram_Inst_245X82_0_432.mem_write(row - 0, shadow_mem[row][513:432]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [513:0] data;
begin
// probing AUTOSARAMPDP_248X144_GL_M2_D2
 if (row >= 0 && row < 245) data[143:0] = r_sa_ram_rwsp_245x514.ram_Inst_245X144_0_0.mem_read(row - 0);
// probing AUTOSARAMPDP_248X144_GL_M2_D2
 if (row >= 0 && row < 245) data[287:144] = r_sa_ram_rwsp_245x514.ram_Inst_245X144_0_144.mem_read(row - 0);
// probing AUTOSARAMPDP_248X144_GL_M2_D2
 if (row >= 0 && row < 245) data[431:288] = r_sa_ram_rwsp_245x514.ram_Inst_245X144_0_288.mem_read(row - 0);
// probing AUTOSARAMPDP_248X82_GL_M2_D2
 if (row >= 0 && row < 245) data[513:432] = r_sa_ram_rwsp_245x514.ram_Inst_245X82_0_432.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
