...
// ================================================================
// File Name: sa_ram_rws_32x272_logic.v
...
module sa_ram_rws_32x272_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
wire gated_clk_core;
SA_CKLNQD12PO4 UJ_clk_gate_core (.Q(gated_clk_core), .CP(clk), .E(clk_en_core), .TE(1'b0 | mbist_en_r | debug_mode_sync | scan_en));
wire shiftDR_en;
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece AUTOSARAMPDP_32X272_GL_M1_D2 (RamCell)
...
// ----------------- begin Ram Cell AUTOSARAMPDP_32X272_GL_M1_D2 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_32X272_GL_M1_D2 ram_Inst_32X272 (
                                          .CLK (gated_clk_core)
                                        , .WADR_4 (wa_0_0[4])
                                        , .WADR_3 (wa_0_0[3])
                                        , .WADR_2 (wa_0_0[2])
...
//For bitEnd 271, only one piece AUTOSARAMPDP_32X272_GL_M1_D2 in the column.
...
SA_ScanShareSel_JTAG_reg_ext_cg #(1, 0, 0) testInst_we_reg_w0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
SA_ScanShareSel_JTAG_reg_ext_cg #(1, 0, 0) testInst_re_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_271_16 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[271:16]), .Q(Data_reg_r0_Q[271:16]),
            .scanin(re_reg_SO_r0), .scanout(so_Data_reg_r0_271_16) );
SA_ScanShareSel_JTAG_reg_ext_cg #(16, 0, 0) testInst_Data_reg_r0_15_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
