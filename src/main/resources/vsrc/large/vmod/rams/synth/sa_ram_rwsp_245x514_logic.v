...
// ================================================================
// File Name: sa_ram_rwsp_245x514_logic.v
...
module sa_ram_rwsp_245x514_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix _0_0 : Piece AUTOSARAMPDP_248X144_GL_M2_D2 (RamCell)
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_144 : Piece AUTOSARAMPDP_248X144_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 247 Addressrange: [7:0]
...
assign re_0_144 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_248X144_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 247 Addressrange: [7:0]
...
assign re_0_288 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_432 : Piece AUTOSARAMPDP_248X82_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 247 Addressrange: [7:0]
...
// ----------------- begin Ram Cell AUTOSARAMPDP_248X144_GL_M2_D2_0_0 -------------
// Write Port Stuff -----
...
AUTOSARAMPDP_248X144_GL_M2_D2 ram_Inst_245X144_0_0 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_248X144_GL_M2_D2_0_144 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_248X144_GL_M2_D2 ram_Inst_245X144_0_144 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_248X144_GL_M2_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_248X144_GL_M2_D2 ram_Inst_245X144_0_288 (
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_248X82_GL_M2_D2_0_432 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_248X82_GL_M2_D2 ram_Inst_245X82_0_432 (
...
//For bitEnd 143, only one piece AUTOSARAMPDP_248X144_GL_M2_D2 in the column.
...
//For bitEnd 287, only one piece AUTOSARAMPDP_248X144_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 431, only one piece AUTOSARAMPDP_248X144_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 513, only one piece AUTOSARAMPDP_248X82_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(8, 0, 0) testInst_Wa_reg_w0 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(8, 0, 0) testInst_Ra_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            .shiftDR(shiftDR),
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_513_258 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_257_2 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[257:2]), .Q(Data_reg_r0_Q[257:2]),
            .scanin(so_Data_reg_r0_513_258), .scanout(so_Data_reg_r0_257_2) );
SA_ScanShareSel_JTAG_reg_ext_cg #(2, 0, 0) testInst_Data_reg_r0_1_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
