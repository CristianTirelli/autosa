// sa_ram_rwsp_4x128: synthesizable model core
...
// leda ELB072 off
`timescale 1ns / 10ps
module sa_ram_rwsp_4x128_logic (
               SI,
               SO_int_net,
               clk,
               debug_mode,
...
SA_CKLNQD12PO4 UJ_la_bist_clkw0_gate (.Q(la_bist_clkw0), .CP(clk), .E(debug_mode_sync), .TE(scan_en));
// Write enable bus
wire we_0_0;
...
SA_CKLNQD12PO4 UJ_clk_gated_w0 (.Q(gated_clk_latch), .CP(clk), .E((we)), .TE(debug_mode_sync | scan_en));
wire shiftDR_en;
...
SA_CKLNQD12PO4 UJ_clk_jtag_Ra_array_reg_r0_reg (.Q(gated_clk_jtag_Ra_array_reg_r0_reg), .CP(clk), .E(debug_mode_sync ? (( 1'b0 | shiftDR ) ) : (muxed_Ra_array_capture_enr0 | 1'b0 | ( 1'b0 ) ) ), .TE(scan_en));
SA_ScanShareSel_JTAG_reg_ext_cg #(2, 0, 0) testInst_Ra_array_reg_r0_reg (
...
SA_CKLNQD12PO4 UJ_clk_jtag_Wdata_w0_reg (.Q(gated_clk_jtag_Wdata_w0_reg), .CP(clk), .E(debug_mode_sync ? (posedge_updateDR_sync| ( 1'b0 | shiftDR ) ) : ((|we_0_0) | 1'b0 | 1'b0 | ( 1'b0 ) ) ), .TE(scan_en));
SA_ScanShareSel_JTAG_reg_ext_cg #(128, 0, 0) testInst_Wdata_w0_reg (
