// sa_ram_rwsp_256x257: synthesizable model core
...
module sa_ram_rwsp_256x257_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_144 : Piece AUTOSARAMPDP_256X113_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 255 Addressrange: [7:0]
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_256X113_GL_M2_D2_0_144 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_256X113_GL_M2_D2 ram_Inst_256X113_0_144 (
...
//For bitEnd 256, only one piece AUTOSARAMPDP_256X113_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_256_1 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[256:1]), .Q(Data_reg_r0_Q[256:1]),
            .scanin(re_reg_SO_r0_0_144), .scanout(so_Data_reg_r0_256_1) );
SA_ScanShareSel_JTAG_reg_ext_cg #(1, 0, 0) testInst_Data_reg_r0_0_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
