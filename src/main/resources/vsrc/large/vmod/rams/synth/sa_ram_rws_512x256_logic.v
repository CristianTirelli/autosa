...
// ================================================================
// File Name: sa_ram_rws_512x256_logic.v
...
module sa_ram_rws_512x256_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign re_0_144 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_216 : Piece AUTOSARAMPDP_512X40_GL_M4_D2 (RamCell)
// Covers Addresses from 0 to 511 Addressrange: [8:0]
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_512X40_GL_M4_D2_0_216 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_512X40_GL_M4_D2 ram_Inst_512X40_0_216 (
...
// verilint 17 on - Range (rather than full vector) in the sensitivity list
//For bitEnd 255, only one piece AUTOSARAMPDP_512X40_GL_M4_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0 (
