...
// ================================================================
// File Name: sa_ram_rws_32x544_logic.v
...
module sa_ram_rws_32x544_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_288 : Piece AUTOSARAMPDP_32X256_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 31 Addressrange: [4:0]
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell AUTOSARAMPDP_32X256_GL_M1_D2_0_288 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
AUTOSARAMPDP_32X256_GL_M1_D2 ram_Inst_32X256_0_288 (
...
//For bitEnd 543, only one piece AUTOSARAMPDP_32X256_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_543_288 (
...
SA_ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_287_32 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[287:32]), .Q(Data_reg_r0_Q[287:32]),
            .scanin(so_Data_reg_r0_543_288), .scanout(so_Data_reg_r0_287_32) );
SA_ScanShareSel_JTAG_reg_ext_cg #(32, 0, 0) testInst_Data_reg_r0_31_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
