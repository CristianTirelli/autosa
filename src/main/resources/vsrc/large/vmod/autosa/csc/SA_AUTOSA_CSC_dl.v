...
//| eperl: generated_end (DO NOT EDIT ABOVE)
  ...
  ,reg2dp_rls_slices //|< i
  ,reg2dp_cosa_x_stride_ext //|< i
  ,reg2dp_cosa_y_stride_ext //|< i
...
input [2:0] reg2dp_cosa_x_stride_ext;
input [2:0] reg2dp_cosa_y_stride_ext;
...
`ifdef AUTOSA_WINOGRAD_ENABLE
assign is_winograd = (reg2dp_cosa_mode == 1'h1 );
`else
...
assign cosa_x_stride_w = (is_winograd) ? 4'b1 : reg2dp_cosa_x_stride_ext + 1'b1;
assign pixel_x_stride_w = (reg2dp_datain_channel_ext[1:0] == 2'h3) ? {cosa_x_stride_w, 2'b0} : //*4, after pre_extension
                          (reg2dp_datain_channel_ext[1:0] == 2'h2) ? ({cosa_x_stride_w, 1'b0} + cosa_x_stride_w) : //*3
                          {2'b0, cosa_x_stride_w}; //*1
//: my $kk=6;
//: if ($kk=6) {
//: print qq (
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
assign cosa_y_stride_w = (is_winograd) ? 4'b1 : reg2dp_cosa_y_stride_ext + 1'b1;
...
//: my $kk= 15;
//: &eperl::flop("-nodeclare -clk autosa_core_ng_clk  -rval \"{14{1'b0}}\"  -en \"cdma2sc_dat_updt | dat_rls | cbuf_reset\" -d \"dat_slice_avl_w\" -q dat_slice_avl");
//: &eperl::flop("-nodeclare -clk autosa_core_ng_clk  -rval \"{${kk}{1'b0}}\"  -en \"cdma2sc_dat_updt | dat_rls | cbuf_reset\" -d \"dat_entry_avl_w\" -q dat_entry_avl");
//: &eperl::flop("-nodeclare -clk autosa_core_ng_clk  -rval \"{${kk}{1'b0}}\"  -en \"cbuf_reset | dat_rls\" -d \"dat_entry_st_w\" -q dat_entry_st");
//: &eperl::flop("-nodeclare -clk autosa_core_ng_clk  -rval \"{${kk}{1'b0}}\"  -en \"cbuf_reset | cdma2sc_dat_updt\" -d \"dat_entry_end_w\" -q dat_entry_end");
//| eperl: generated_beg (DO NOT EDIT BELOW)
...
assign {mon_datain_w_cnt_inc,datain_w_cnt_inc} = (is_winograd_d1[3]) ? (datain_w_cnt + 2'h2) : (datain_w_cnt + cosa_x_stride);
...
assign {mon_datain_h_cnt_inc, datain_h_cnt_inc} = datain_h_cnt + cosa_y_stride;
...
assign dat_cosa_req_dummy = (datain_w_cur[13 ]) | (datain_w_cur > {1'b0, datain_width_cmp})
...
assign dat_req_dummy = is_img_d1[5] ? dat_img_req_dummy : is_winograd_d1[4] ? dat_wg_req_dummy : dat_cosa_req_dummy;
...
// PKT_PACK_WIRE( autosa_stripe_info , dat_req_ , dat_req_flag_w )
...
assign sc2buf_dat_rd_next1_en = 1'b0;
assign sc2buf_dat_rd_next1_en_w = 1'b0;
assign sc2buf_dat_rd_shift = {10{1'b0}};
`endif
...
// PKT_UNPACK_WIRE( autosa_stripe_info , dat_rsp_ , dat_rsp_flag )
...
////: &eperl::retime("-O stripe_begin_disable_jump_7T -i stripe_begin_disable_jump -stage 8 -clk autosa_core_clk");
////: &eperl::flop("-q stripe_begin_disable_jump_8T -d stripe_begin_disable_jump_7T -clk autosa_core_clk");
...
`endif
`ifdef AUTOSA_PRINT_WINOGRAD
always @ (posedge autosa_core_clk)
begin
    if(dat_rsp_pra_en)
    begin
        $display("[AUTOSA WINOGRAD] data_pre_pra_remap  = %01024h", dat_rsp_wg);
        $display("[AUTOSA WINOGRAD] data_post_pra_remap = %01024h", {dat_rsp_wg_ch3, dat_rsp_wg_ch2, dat_rsp_wg_ch1, dat_rsp_wg_ch0});
    end
end
always @ (posedge autosa_core_clk)
begin
    ...
    begin
        $display("[AUTOSA WINOGRAD] data_pra_out_ch0 = %0256h", dat_pra_dat_ch0);
        $display("[AUTOSA WINOGRAD] data_pra_out_ch1 = %0256h", dat_pra_dat_ch1);
        $display("[AUTOSA WINOGRAD] data_pra_out_ch2 = %0256h", dat_pra_dat_ch2);
        $display("[AUTOSA WINOGRAD] data_pra_out_ch3 = %0256h", dat_pra_dat_ch3);
    end
end
...
`ifdef CC_ATOMC_DIV_ATOMK_EQUAL_1
assign dat_rsp_cosa_8b = (is_winograd_d1[14] | is_img_d1[26]) ? {512{1'b0}} :
                         dat_rsp_l0c0;
`endif
`ifdef CC_ATOMC_DIV_ATOMK_EQUAL_2
assign dat_rsp_cosa_8b = (is_winograd_d1[14] | is_img_d1[26]) ? {512{1'b0}} :
...
dat_rsp_l0c0;
`endif
assign dat_rsp_conv = dat_rsp_cosa_8b;
//////////////// data for image ////////////////
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
SA_AUTOSA_CSC_pra_cell u_pra_cell_0 (
   .autosa_core_clk (autosa_wg_clk) //|< i
...
SA_AUTOSA_CSC_pra_cell u_pra_cell_1 (
   .autosa_core_clk (autosa_wg_clk) //|< i
  ,.autosa_core_rstn (autosa_core_rstn) //|< i
...
SA_AUTOSA_CSC_pra_cell u_pra_cell_2 (
   .autosa_core_clk (autosa_wg_clk) //|< i
  ,.autosa_core_rstn (autosa_core_rstn) //|< i
...
SA_AUTOSA_CSC_pra_cell u_pra_cell_3 (
   .autosa_core_clk (autosa_wg_clk) //|< i
  ,.autosa_core_rstn (autosa_core_rstn) //|< i
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
`ifdef AUTOSA_PRINT_DL
always @ (posedge autosa_core_clk)
begin
    if(layer_st)
    begin
        $display("[AUTOSA DL] layer start");
    end
end
always @ (posedge autosa_core_clk)
begin
    ...
    begin
        $display("[AUTOSA DL] sc2mac_dat = %01024h", dbg_csc_dat);
    end
end
`endif
`endif
endmodule // SA_AUTOSA_CSC_dl
