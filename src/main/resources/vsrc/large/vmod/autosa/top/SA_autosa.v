...
module SA_autosa (
  ...
  ,autosa_core2cvsram_aw_awvalid //|> o
  ,autosa_core2cvsram_aw_awready //|< i
  ,autosa_core2cvsram_aw_awid //|> o
  ,autosa_core2cvsram_aw_awlen //|> o
  ,autosa_core2cvsram_aw_awaddr //|> o
  ,autosa_core2cvsram_w_wvalid //|> o
  ,autosa_core2cvsram_w_wready //|< i
  ,autosa_core2cvsram_w_wdata //|> o
  ,autosa_core2cvsram_w_wstrb //|> o
  ,autosa_core2cvsram_w_wlast //|> o
  ,autosa_core2cvsram_b_bvalid //|< i
  ,autosa_core2cvsram_b_bready //|> o
  ,autosa_core2cvsram_b_bid //|< i
  ,autosa_core2cvsram_ar_arvalid //|> o
  ,autosa_core2cvsram_ar_arready //|< i
  ,autosa_core2cvsram_ar_arid //|> o
  ,autosa_core2cvsram_ar_arlen //|> o
  ,autosa_core2cvsram_ar_araddr //|> o
  ,autosa_core2cvsram_r_rvalid //|< i
  ,autosa_core2cvsram_r_rready //|> o
  ,autosa_core2cvsram_r_rid //|< i
  ,autosa_core2cvsram_r_rlast //|< i
  ,autosa_core2cvsram_r_rdata //|< i
  ,dla_intr //|> o
...
SA_AUTOSA_partition_o u_partition_o (
  ...
  ,.cvif2noc_axi_ar_arvalid (autosa_core2cvsram_ar_arvalid)
  ,.cvif2noc_axi_ar_arready (autosa_core2cvsram_ar_arready)
  ,.cvif2noc_axi_ar_arid (autosa_core2cvsram_ar_arid[7:0])
  ,.cvif2noc_axi_ar_arlen (autosa_core2cvsram_ar_arlen[3:0])
  ,.cvif2noc_axi_ar_araddr (autosa_core2cvsram_ar_araddr)
  ,.cvif2noc_axi_aw_awvalid (autosa_core2cvsram_aw_awvalid)
  ,.cvif2noc_axi_aw_awready (autosa_core2cvsram_aw_awready)
  ,.cvif2noc_axi_aw_awid (autosa_core2cvsram_aw_awid[7:0])
  ,.cvif2noc_axi_aw_awlen (autosa_core2cvsram_aw_awlen[3:0])
  ,.cvif2noc_axi_aw_awaddr (autosa_core2cvsram_aw_awaddr)
  ,.cvif2noc_axi_w_wvalid (autosa_core2cvsram_w_wvalid)
  ,.cvif2noc_axi_w_wready (autosa_core2cvsram_w_wready)
  ,.cvif2noc_axi_w_wdata (autosa_core2cvsram_w_wdata)
  ,.cvif2noc_axi_w_wstrb (autosa_core2cvsram_w_wstrb)
  ,.cvif2noc_axi_w_wlast (autosa_core2cvsram_w_wlast)
  ,.noc2cvif_axi_b_bvalid (autosa_core2cvsram_b_bvalid)
  ,.noc2cvif_axi_b_bready (autosa_core2cvsram_b_bready)
  ,.noc2cvif_axi_b_bid (autosa_core2cvsram_b_bid[7:0])
  ,.noc2cvif_axi_r_rvalid (autosa_core2cvsram_r_rvalid)
  ,.noc2cvif_axi_r_rready (autosa_core2cvsram_r_rready)
  ,.noc2cvif_axi_r_rid (autosa_core2cvsram_r_rid[7:0])
  ,.noc2cvif_axi_r_rlast (autosa_core2cvsram_r_rlast)
  ,.noc2cvif_axi_r_rdata (autosa_core2cvsram_r_rdata)
